...
<script>
    ...
    let vue = new Vue({
        ...
        created: function(){
            axios.get('/api/admin/certificate/new/certificates')
                .then(r=> this.certificates=r.data );
        },
        methods: {
            getCertificate: function () {
                axios.post('/api/admin/certificate/new/certificate', {'id': parseInt($('#certificateSelected').val())}).then(r => {
                    this.certificateImage = r.data;
                });
            },
            getCertificate2: function () {
                axios.post('/api/admin/certificate/new/certificate', {'id': parseInt($('#certificateSelected2').val())}).then(r => {
            ...
            authenticate: function () {
                ...
                axios.post('/api/admin/certificate/new/authenticate',{tfIds, teamIds, certificate})
            ...
            authenticate2: function () {
                ...
                axios.post('/api/admin/certificate/new/nameInsert',{names, certificate})
                    .then(r=>{
                        if(r.data==='Done!')
                            iziToast.success({message:'Successfully authenticated all the participants for the certificate!'})
                        let e = r.data;
                        e.forEach(function(a){
                            axios.get('https://techfest.org/admin/certificate/new/generate/'+a)
                                .then(response=>{
            ...
            nameInsert: function(){
                let names = $('#ids2').val().split(',');
                axios.post('/api/admin/certificate/new/nameInsert',{names})
                    .then((r)=>{
                        console.log('hello');
                        console.log(r);
                    });
