...
<head>
    ...
    @if(isset($name))
        <meta property="og:description" content="{{$name or ''}} made a highscore of {{$score or ''}}">
    @else
...
<script>
    (() => {
        ...
        let $shareBtn = $('.share');
        // shared variables
        let currentScore, highScore, name;
        ...
        function updateScore(newCurrentScore) {
            ...
            let k = 'https://techfest.org/404/'+window.btoa(name)+'/'+window.btoa(highScore);
