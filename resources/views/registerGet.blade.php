...
<head>
    ...
    <title>Techfest 2018-19 </title>
    <link rel="stylesheet" href="{{asset('css/app.css')}}">
    <link rel="icon" href="{{asset('2018/favicon.png')}}">
...
<body>
<div id="app">
    <div class="loginFirst" v-if="showLogin" @click="register">
        <div class="text-white w-100 h-100"> To join the link, click on the login button first to login with google
            <br>
        ...
        <div class="centered">
            <div class="modal-body">
                ...
                <div class="input-group">
                    ...
                    <input type="date" placeholder="DOB" max="2012-12-31" min="1800-01-01" name="dob" v-model="registerDetails.dob">
                ...
                <div class="input-group">
                    <button @click="loginSubmit" class="btn btn-success">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    const _routes = {
        ...
        'homePng':'https://techfest.org/home.png'
    };
    const csrf = {
        'token':'{!! csrf_token() !!}',
        'field':'{!! csrf_field() !!}'
