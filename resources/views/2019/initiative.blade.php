...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            @endif
            <p>
                In addition to the promotion of science and technology, we at Techfest believe in creating an impact to change people's lives for the better. Having executed record-breaking social initiatives with endorsements from Yami Gautam and Taapsee Pannu, watch out for the launch of this year's Techfest Initiatives on this site!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
...
{{--            <a href="" style="padding: 10px;color: black">7400400933</a>--}}
        ...
        <div style="height: 36px">
            ...
            <a href="" style="padding: 10px;color: black">oc@techfest.org</a>
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/initiative website.jpg');">
    </div>
</div>
