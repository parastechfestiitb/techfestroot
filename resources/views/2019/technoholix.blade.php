...
<html lang="en">
<head>
    <title>Technoholix | Techfest, IIT Bombay</title>
    <meta charset="UTF-8">
...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            @endif
            <p>
                Featuring performances and concerts from renowned International performers and DJs, Technoholix is the most glamorous extravaganza that Techfest offers. Stay tuned for more updates about the grand concluding spectacle of Techfest!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/techx.jpg');">
    </div>
</div>
