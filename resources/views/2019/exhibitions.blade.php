...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            @endif
            <p>
                Techfest's International Exhibitions bring together, for you, cutting-edge technologies for showcase from all over the world to IIT Bombay. Stay tuned for the releases of the International exhibitors visiting in the next edition of Techfest, IIT Bombay!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
        ...
        <div>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">Sachit Shanbhag</a>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">+91 9967235914</a>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">sachit@techfest.org</a>
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/exhibitions.jpg');">
    </div>
</div>
