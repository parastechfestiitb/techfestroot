...
{{--    <link rel="stylesheet" href="/2019/robowars/css3/footer with 3 col.css">--}}
    ...
    <script src="/2019/robowars/js3/modernizr.custom.97074.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav" style="width: 100%;">
            <ul class="navbar-nav nav ml-auto">
                ...
                <li class="nav-item"><a href="/ift/form" class="nav-link"><span>Registration</span></a></li>
...
<section class="home-slider js-fullheight owl-carousel" style="background: white;pointer-events: none">
    <div class="slider-item js-fullheight" style="background-image:url('/2019/ift/gallery/Screenshot_1.jpg');">
            ...
            <div class="row">
                    ...
                    <div class="flip-card " style="padding: 10px 20px;">
                        <div class="flip-card-inner">
                            <div class="flip-card-front revealOnScroll delay-500ms" data-animation="fadeInUp">
                                <img src="/2019/ift/drivers/Robert.png" alt="judge" style="    width: 100%;">
                            </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="text-align: center">
                    ...
                    <div class="flip-card" style="padding: 10px 20px;">
                        <div class="flip-card-inner">
                            <div class="flip-card-front revealOnScroll delay-500ms " data-animation="fadeInUp">
                                <img src="/2019/ift/drivers/Joao.png" alt="anchor" style="    width: 100%;">
                            </div>
                            <div class="flip-card-back">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="text-align: center">
                    ...
                    <div class="flip-card" style="padding: 10px 20px;">
                        <div class="flip-card-inner">
                            <div class="flip-card-front revealOnScroll delay-500ms " data-animation="fadeInUp">
                                <img src="/2019/ift/drivers/rayan2.png" alt="anchor" style="    width: 100%;">
                            </div>
                            <div class="flip-card-back">
            ...
            <div class="row">
                <div class="col-md-4">
                    <figure class="snip1105 yellow">
                        <img src="/2019/ift/gallery/Screenshot_1.jpg" alt="sample36" />
                        <figcaption>
                            <div class="icons">
                                <a href="/2019/compi/ps/IFT-V1.pdf" target="_blank"><i class="fas fa-download"></i></a>
                            </div>
                ...
                <div class="col-md-4">
                    <figure class="snip1105 yellow">
                        <img src="/2019/ift/buggy2.jpg" alt="sample36" />
                        <figcaption>
                            <div class="icons">
{{--                                <a href="/2019/robowars/Problem Statement - 60kgs.pdf" target="_blank"><i class="fas fa-download"></i></a>--}}
                ...
                <div class="col-md-4">
                    <figure class="snip1105 yellow">
                        <img src="/2019/ift/images.jpg" alt="sample36" />
                        <figcaption>
                            <div class="icons">
                    ...
                    <div class="row ftco-animate">
                        <div class="col-md-12 testimonial">
                            <div class="carousel-testimony owl-carousel ftco-owl">
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/circuit.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/gopro.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/ift_collage.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/ift_collage3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/ift_collage_5.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/professional_presentor.jpg" alt="">
                                    </div>
                                </div>

                                <div class="item">
                                    <div class=" img">
                                        <img src="/2019/ift/gallery/three.jpg" alt="">
                                    </div>
                                </div>
