...
<head>
    ...
    <title>CodeBuzz | Techfest, IIT Bombay</title>
    ...
    <style>
        ...
        @media (min-width:992px) {
            ...
            .mobile_hide{
                ...
                background-image: url(/2019/compi/images/codebuzz_new.jpg) ;
...
{{--        <a href="https://www.codingninjas.in/"><img src="/2019/compi/images/Asset 3.png" alt="" style="width: 65%; margin-top: 10%;"></a>--}}
        <a href="#"><img  src="/2019/compi/images/gehc.jpg" alt="" style="width: 65%; margin-top: 10%;background-color: white"></a>
                    ...
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft" style="margin-right:-1%; padding-left:2.5% ;padding-right: -50%">
                        <div class="about-desc" style="margin-right: 0%; padding: 0px" >
                            ...
                            <div style="display: inline">
                                <h2 style="color: white; font-weight: bold;display: inline">GEHC CodeBuzz</h2>
                                {{--                                <a href="https://www.jlt.com/"><img  src="/2019/compi/images/jlt_logo.png" alt="" style="max-height: 6vh;margin-top: -13px;"></a>--}}
                            </div>

                            <hr style="color: white; border: 1px solid white">
                            <h3 style="color: white">Prizes Money: INR 50,000/- </h3>
                            <h3 style="color: white">Date: 5th January, 2020 </h3>
                            <h3 style="color: white">Venue: IIT Bombay </h3>


                            <p style=" font-size: 15px; width:90%; font-family: Lato;color: white; text-align: justify ">
                                Participants are required to solve coding problems. Programming and algorithmic skills of the participants will be tested.
                                <br>Date for the competition is 5th January, 2020.
                            </p>
...
{{--                                    <a href="#" class="btn btn-primary btn-learn" >Registration Closed</a>--}}
                            ...
                            @if(!empty($user_row))
                                @if($user_row->codebuzz > 0 )
                                    <div class="alert alert-success">
                                        <p><strong>Hi {{$user_row->name}}, you are successfully registered for GEHC CodeBuzz with <b>{{$user_row->email}}</b> as your Registered email id.</strong></p>
                                    </div>
                                @endif
                            @endif
        ...
        <div id="text_change" class="col-md-12 animate-box scroll_inside" data-animate-effect="fadeInLeft" style="
            ...
            <p id="text_change" style="margin-bottom: 0px; color: white">
                <br>
                Format: It is an online programming contest. It will be conducted in IIT Bombay during Techfest.
...
<script>
    function myFunction3() {
        ...
        document.getElementById("text_change").innerHTML = "<br>Q. Why should I participate in GEHC CodeBuzz?<br>" +
            "This Game of Codes provides the participants with amazing coding challenges to showcase their coding skills.<br>" +
            ...
            "<br> <br>Q. How to register for GEHC CodeBuzz?" +
            "<br>Please follow these steps: www.techfest.org -> Competitions -> GEHC CodeBuzz -> Register" +
            "<br> <br>Q. Where should I report to give this test?" +
            "<br>You have to report to Lecture Hall Complex, IIT Bombay for this competition."+
...
<script>
    function myFunction2() {
        ...
        document.getElementById("text_change").innerHTML = " <br>" +
            ...
            "<br>Certificate Policy: Certificate of excellence will be awarded to the top winners.<br><br>";
        document.body.click("body");
...
<script>
    function myFunction4() {
        document.getElementById("text_change").innerHTML = "<br>Naman Nahar<br>+91 7737767478<br>  techfest.naman@gmail.com<br><br> ";
        document.body.click("body");
