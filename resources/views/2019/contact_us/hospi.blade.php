    ...
    <div class="main">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Hospitality and FnB Managers <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-3" style="padding-top: 4%;"></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <h5 style="text-align: center;color: white;font-size: 1.3em">Waqas Ahmad</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">waqas@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">9082402186</h5>
            </div>
            <div class="col-md-3">
                <img src="/2019/contactus/bhuvanesh.jpg" alt="" style="width: 100%;">
                <h5 style="text-align: center;color: white;font-size: 1.3em">Bhuvanesh Gupta</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">bhuvanesh@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">8949802814</h5>
            </div>
            <div class="col-md-3"></div>
        </div>
