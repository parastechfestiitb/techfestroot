    ...
    <div class="main">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Marketing Managers <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-3" style="padding-top: 4%;"></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <h5 style="text-align: center;color: white;font-size: 1.3em">Pratik Phule</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">pratik@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">7038560585</h5>
            </div>
            <div class="col-md-3">
                <img src="/2019/contactus/sahildixit.jpg" alt="" style="width: 100%;">
                <h5 style="text-align: center;color: white;font-size: 1.3em">Sahil Dixit</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">sahildixit@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">8433834838</h5>
            </div>
            <div class="col-md-3"></div>
        </div>
