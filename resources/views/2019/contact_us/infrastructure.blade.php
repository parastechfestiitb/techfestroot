    ...
    <div class="main">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Infrastructure Managers <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-3" style="padding-top: 4%;"></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <h5 style="text-align: center;color: white;font-size: 1.3em">Vaibhav Shinde</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">vaibhav@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">7030530275</h5>
            </div>
            <div class="col-md-3">
                <img src="/2019/contactus/kushal.jpg" alt="" style="width: 100%;">
                <h5 style="text-align: center;color: white;font-size: 1.3em">Kushal Verma</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">kushal@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">9082401361</h5>
            </div>
            <div class="col-md-3"></div>
        </div>
