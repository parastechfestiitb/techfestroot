        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Lecture Manager <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-3" style="padding-top: 4%;"></div>
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h5 style="text-align: center;color: white;font-size: 1.3em">Naman Agarwal</h5>
                        <h5 style="text-align: center;color: white;font-size: 1.3em">naman@techfest.org</h5>
                        <h5 style="text-align: center;color: white;font-size: 1.3em">7700906731</h5>
                    </div>
                    <div class="col-md-3"></div>
            </div>
            <div class="col-md-3"></div>
