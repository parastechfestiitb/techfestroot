    ...
    <div class="main">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Robowars Managers <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-3" style="padding-top: 4%;"></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <h5 style="text-align: center;color: white;font-size: 1.3em">Akshat Johri</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">akshat@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">9892897448</h5>
            </div>
            <div class="col-md-3">
                <img src="/2019/contactus/vibhav.jpg" alt="" style="width: 100%;">
                <h5 style="text-align: center;color: white;font-size: 1.3em">Vibhav Bhargava</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">vibhav@techfest.org</h5>
                <h5 style="text-align: center;color: white;font-size: 1.3em">9827323969</h5>
            </div>
            <div class="col-md-3"></div>
        </div>
