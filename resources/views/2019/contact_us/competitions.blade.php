...
<div class="wrapper">
    <div class="main">
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-1" style="padding-top: 4%;"></div>
                <div class="col-md-10" style="padding-top: 4%;">
                    <h2 style="text-align: center;color: white">Competitions Managers <a href="/contact-us/" style="float: right"> <i class="fas fa-times" ></i></a></h2>
                    <hr>
                </div>
                <div class="col-md-1" style="padding-top: 4%;"></div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row" style="width: 90%; margin-left: 5%;">
                            ...
                            <div class="col-md-4">
                                ...
                                <h5 style="text-align: center;color: white;font-size: 1.3em">Manjeet Singh</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">manjeet@techfest.org</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">7568387238</h5>
                            </div>
                            <div class="col-md-4">
                                <img src="/2019/contactus/om.jpg" alt="" style="width: 100%;">
                                <h5 style="text-align: center;color: white;font-size: 1.3em">Om Jaiswal</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">omjaiswal@techfest.org</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">7400400933</h5>
                            </div>
                            <div class="col-md-4">
                                <img src="/2019/contactus/abhinav.jpg" alt="" style="width: 100%;">
                                <h5 style="text-align: center;color: white;font-size: 1.3em">Abhinav Kumar</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">abhinav@techfest.org</h5>
                                <h5 style="text-align: center;color: white;font-size: 1.3em">8299544527</h5>
                            </div>
                        </div>
                    </div>
