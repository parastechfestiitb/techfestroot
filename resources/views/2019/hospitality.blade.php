...
{{--                Accomodation Portal Releasing Soon--}}
{{--            </h3>--}}
            @if($errors->any())
            ...
            @endif
            <p>
                To provide a satisfying and lavish stay for you in the campus of IIT Bombay as you participate in Techfest's plethora of events, we ensure that you enjoy the most comfortable hospitality. Stay tuned for the launch of our Hospitality Portal, where you can register and avail our amenities!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
                Accomodation Portal releasing soon!
        ...
        <div>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">Waqas Ahmad</a>

            </div>
            <div style="height: 36px">

                <a href="mailto:waqas@techfest.org" target="_top" style="padding: 10px;color: black">waqas@techfest.org</a>

            </div>
            <div style="height: 36px">

                <a href="tel:+918875713858" style="padding: 10px;color: black">+91 8875713858</a>
...
{{--            </div>--}}
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/hospi.jpg'); background-size: cover;">
    </div>
</div>
