...
<html lang="en">
<head>
    <title>Robowars | Techfest, IIT Bombay</title>
    <meta charset="UTF-8">
...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        <div class="wrappic1">
            <a href="/">
                <img style="max-height: 60px" src="/2019/tf_date_black.png" alt="IMG">
            </a>
        </div>
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            @endif
            <p>
                Witness sparks fly as metal crushes metal in the most glorious robot battles interspersed with magnificent artist performances for non-stop entertainment. Stay tuned and brace yourselves to be a part of Asia's largest robotic extravaganza at Techfest this year!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
        ...
        <div>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">Akshat Johri</a>
            ...
            <div style="height: 36px">
                ...
                <a href="tel:+919892997448" style="padding: 10px;color: black">+91 98928 97448</a>
            ...
            <div style="height: 36px">
                ...
                <a href="mailto:akshat@techfest.org" target="_top" style="padding: 10px;color: black">akshat@techfest.org</a>
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/robo.jpg');">
    </div>
</div>
