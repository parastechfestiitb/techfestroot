...
<head>
    <script type="text/javascript">
        if (screen.width <= 992) {
            document.location = "/m/contact-us";
        }
    </script>
    <meta charset="utf-8">
...
<div class="outer_box">
    <div class="contactus_heading">
        <h2 style="text-align: center;color: white;">Team Techfest 2019-20</h2>
    </div>
    <a href="/contact-us/overall-coordinators">
        <div style="clip-path: polygon(25% 0, 75% 0, 100% 50%, 75% 100%, 25% 100%, 0 50%);" class="center_image" href=""> <img style="width: 100%; align-items: center" src="/2019/contactus/oc.png" alt="sdfsjfbj"> </div>

    </a>

    <a href="/contact-us/exhibitions">
        <div style="clip-path: polygon(0 0, 75.1% 0, 100% 100%, 24.9% 100%);" class="center_right_top"> <img style="width: 100%; align-items: center" src="/2019/contactus/exhi.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/robowars">
        <div style="clip-path: polygon(0 100%, 75.1% 100%, 100% 0%, 24.9% 0%);" class="center_right_bottom"> <img style="height: 100%; align-items: center" src="/2019/contactus/rwnacc.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/marketing">
        <div style="clip-path: polygon(0 100%, 75.1% 100%, 100% 0%, 24.9% 0%);" class="center_left_top"> <img style="height: 100%; align-items: center" src="/2019/contactus/marki.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/web-creatives">
        <div style="clip-path: polygon(0 0, 75.1% 0, 100% 100%, 24.9% 100%);" class="center_left_bottom"> <img style="width: 100%; align-items: center" src="/2019/contactus/webndes.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/lectures">
        <div style="clip-path: polygon(0 0, 86% 0, 100% 50%, 86% 100%, 0 100%, 14% 50%);" class="center_right_ex"> <img style="width: 100%; align-items: center" src="/2019/contactus/lectures.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/ozone">
        <div style="clip-path: polygon(0 0, 75.1% 0, 100% 100%, 24.9% 100%);" class="center_right_ex_top"> <img style="width: 100%; align-items: center" src="/2019/contactus/ozone.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/technoholix">
        <div style="clip-path: polygon(0 100%, 75.1% 100%, 100% 0%, 24.9% 0%);" class="center_right_ex_bottom"> <img style="width: 100%; align-items: center" src="/2019/contactus/techx.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/media-publicity">
        <div style="clip-path: polygon(0 100%, 75.1% 100%, 100% 0%, 24.9% 0%);" class="center_left_ex_top" > <img style="width: 100%; align-items: center" src="/2019/contactus/medpub.png" alt="sdfsjfbj"></div>
    </a>

    <a href="/contact-us/hospitality-fnb">
        <div style="clip-path: polygon(0 0, 75.1% 0, 100% 100%, 24.9% 100%);" class="center_left_ex_bottom"> <img style="width: 100%; align-items: center" src="/2019/contactus/hosfnb.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/infrastructure">
        <div style="clip-path: polygon(100% 0, 14% 0, 0% 50%, 14% 100%, 100% 100%, 86% 50%);" class="center_left_ex"> <img style="width: 100%; align-items: center" src="/2019/contactus/infra.png" alt="sdfsjfbj"></div>

    </a>

    <a href="/contact-us/competitions">
        <div style="clip-path: polygon(0 0, 100% 0, 86.3% 100%, 13.7% 100%);" class="bottom_ex"> <img style="height: 100%; align-items: center" src="/2019/contactus/compi.png" alt="sdfsjfbj"></div>

    </a>

    <h3 style="position: absolute; left: 44% ; top: calc(53% ); color: white; font-family: Lato;">Overall Coordinators</h3>
    <h3 style="position: absolute; left: 26% ; top: calc(39% ); color: white; font-family: Lato">Marketing</h3>
    <h3 style="position: absolute; left: 68% ; top: calc(39% ); color: white; font-family: Lato">Exhibitions</h3>
    <h3 style="position: absolute; left: 77.5% ; top: calc(79% ); color: white; font-family: Lato">Technoholix</h3>
    <h3 style="position: absolute; left: 84.5% ; top: calc(27% ); color: white; font-family: Lato">Ozone</h3>
    <h3 style="position: absolute; left: 64.5% ; top: calc(65.5% ); color: white; font-family: Lato">Robowars</h3>
    <h3 style="position: absolute; left: 46% ; top: calc(91% ); color: white; font-family: Lato">Competitions</h3>
    <h3 style="position: absolute; left: 12% ; top: calc(27% ); color: white; font-family: Lato">Media & Publicity</h3>
    <h3 style="position: absolute; left: 16% ; top: calc(79% ); color: white; font-family: Lato">Hospitality and F&B</h3>
    <h3 style="position: absolute; left: 10% ; top: calc(53% ); color: white; font-family: Lato">Infrastructure</h3>
    <h3 style="position: absolute; left: 30% ; top: calc(66% ); color: white; font-family: Lato">Web & Creatives</h3>
    <h3 style="position: absolute; left: 85.5% ; top: calc(53% ); color: white; font-family: Lato">Lectures</h3>
</div>
