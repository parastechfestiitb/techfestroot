...
<div class="wrapper">
    <div class="main">
        <section class="page1" id="page1">
            <div class="row" style="top: 20vh;position: absolute;width: 100vw;">
                <div class="col-md-1"></div>
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-5">
                            <iframe style="width: 100%; height: 60vh" src="https://www.youtube.com/embed/cgvCY_L80p8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="col-md-7" style="color: white;    border: solid; border-radius: 20px;  padding: 4%; ">
                            <p style="font-size: 2.2vh;">

                                <br> Most people believe that Art and Science are extremely unrelated disciplines, but the truth is that both of them are fundamentally essential to creation and innovation. Throughout human history, science and art have gone hand in hand: each of them arising from, impacting, and in turn inspiring the other. Some of the best scientific minds ever have also been gifted artists. Famously, Einstein himself said that if not a physicist, he would certainly have chosen to be a violinist!

                                <br> The fusion of creative and rational brilliance is perfectly symbolised by Leonardo Da Vinci: who achieved lasting greatness for his endeavours in the arts (Mona Lisa, Last Supper) as well as his contributions to science (neuroanatomy, the Vitruvian Man).

                                <br> Through this year’s theme, Techfest aims to explore the myriad ways in which these two parallels meet. Join us in exploring these new horizons even as you enjoy the grand displays of cutting-edge technology that Techfest is known for. Welcome to Techfest 2019-2020: Da Vincian Spectacle!
