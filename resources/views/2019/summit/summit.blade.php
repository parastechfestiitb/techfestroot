...
<section class="hero-wrap js-fullheight " style="background-image: url('/2019/summit/images/new-min.jpeg');" data-section="home">
    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-6 col-lg-6 d-flex">
                <div class="img-about img d-flex align-items-stretch">
                    <div class="img d-flex align-self-stretch align-items-end" style="background-image:url(/2019/summit/images/g-min.jpg);">
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(/2019/summit/images/Sanjeev.JPG);"></div>
                    </div>
                    <div class="text d-flex align-items-center pt-3 text-center">
                        <div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(/2019/summit/images/Atul.jpg);"></div>
                    </div>
                    <div class="text d-flex align-items-center pt-3 text-center">
                        <div>
...
{{--                <div class="staff">--}}
{{--                    <div class="img-wrap d-flex align-items-stretch">--}}
{{--                        <div class="img align-self-stretch" style="background-image: url(/2019/summit/images/avik.jpg);"></div>--}}
{{--                    </div>--}}
{{--                    <div class="text d-flex align-items-center pt-3 text-center">--}}
{{--                        <div>--}}
...
{{--            </div>--}}
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(/2019/summit/images/vijoybasu.jpg);"></div>
                    </div>
                    <div class="text d-flex align-items-center pt-3 text-center">
                        <div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(/2019/summit/images/SravaniBhattacharjee.jpeg); background-position: center"></div>
                    </div>
                    <div class="text d-flex align-items-center pt-3 text-center">
                        <div>
    ...
    <div class="container" >
        ...
        <div class="row">
            <div class="col-md ftco-animate" style="margin-top: auto; margin-bottom: auto;">
                <img src="/2019/summit/images/tata.jpg" alt="" style="width: 100%">
            </div>
            <div class="col-md ftco-animate" style="margin-top: auto; margin-bottom: auto;">
                <img src="/2019/summit/images/mmc.png" alt="" style="width: 100%">
            </div>
            <div class="col-md ftco-animate" style="margin-top: auto; margin-bottom: auto;">
                <img src="/2019/summit/images/team.png" alt="" style="width: 100%">
            </div>
        </div>
        <div class="row">
            <div class="col-md ftco-animate" style="margin-top: auto; margin-bottom: auto;">
                <img src="/2019/summit/images/abzooba.png" alt="" style="width: 100%">
            </div>
            <div class="col-md   ftco-animate" style="margin-top: auto; margin-bottom: auto;">
