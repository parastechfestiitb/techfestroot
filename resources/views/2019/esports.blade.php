...
<html lang="en">
<head>
    <title>Esports | Techfest, IIT Bombay</title>
    <meta charset="UTF-8">
...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            <p>
                Where every fan cheers and each player can experience the thrill of victory, Techfest Gamers League is the perfect destination to witness gaming giants clash in electrifying leagues and tournaments. Stay tuned as we present something grand this year!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
