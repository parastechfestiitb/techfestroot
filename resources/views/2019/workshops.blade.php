...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
            ...
            @endif
            <p>
                A place-to-be for all tech enthusiasts, where you get mentorship from top professionals and certified hands-on training on the trending technologies. Keep looking for more updates, as we bring to you one of the greatest workshops line-up this year!
            </p>
            <br>
            <p class="m2-txt1 p-b-46">
