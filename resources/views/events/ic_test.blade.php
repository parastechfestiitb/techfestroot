...
<div class="materialContainer">
    ...
    <div class="box">
        ...
        <div class="input">
            <p>Innovation Challenge 2019-20 Problem Statement</p>
            <label for="name"><a href="/2019/ic/ProblemStatement.pdf">Click here to download</a></label>
            <span class="spin"></span>
        </div>
        <div class="input">
            <p for="name">Roll number and Password has been mailed to your registered email address within 24Hrs</p>
            <span class="spin"></span>
        </div>
        <div>
            ...
            <p>*If you haven't received your mail, check your spam folder.</p>
        </div>
