    ...
    <style>
        *, *:before, *:after {
        ...
        .cont {
            position: relative;
            height: 100%;
            background-image: url("/2019/ic/background.jpeg");
    ...
    <div class="demo">
        <div class="login">
            ...
            <div class="login__form">
                ...
                @endif
                <form action="/initiatives/financial_literacy/login/success" method="post">
                    {!! csrf_field() !!}
                    <div class="login__row">
                        ...
                        <input type="number" name="email" class="login__input name" placeholder="Roll Number"/>
                    </div>
                    <div class="login__row">
                        <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
                            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
                        </svg>
                        <input type="password" name="key" class="login__input pass" placeholder="Password"/>
                    </div>
