    ...
    <div class="wrapper wrapper--w960">
        <div class="card card-2">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="/innovationchallenge/post">
                    {!! csrf_field() !!}
                    ...
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="Date of Birth (DD/MM/YYYY)" name="dob" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-2" type="text" placeholder="School Name" required  name="school" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
