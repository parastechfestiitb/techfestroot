...
<!-- meta character set -->
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>Financial Literacy Test 2019 | Techfest, IIT Bombay</title>
...
{{--                    <div class="col-lg-5 afty hide1" data-aos="zoom-in" style="pointer-events: none; overflow: visible;background-size: 80%;    background: url(/2019/initiatives/financial_literacy/tflogoblue.jpg) no-repeat center right/contain;"></div>--}}
                    <div class="col-lg-5 afty hide1" data-aos="zoom-in" style="pointer-events: none; overflow: visible;background-size: 80%;    background: url(/2019/initiatives/financial_literacy/iunderstand.png ) no-repeat center right/contain;"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4" data-aos="zoom-in">
                    <div class="single-feature">
                        <div class="container1">
                            ...
                            <p class="title1">100+<br><span style="line-height: 35px;">COLLEGES</span></p>
                ...
                <div class="col-md-4" data-aos="zoom-in">
                    <div class="single-feature">
                        <div class="container1">
                            ...
                            <p class="title1">25,000+<br><span style="line-height: 35px;">STUDENTS</span></p>
                            <div class="overlay1"></div>
...
<style>
    .story-area:after {
        ...
        width: 50%;
        height: 100%;
        background: url(/2019/initiatives/financial_literacy/tflogoblue.jpg) no-repeat center center/cover;
        z-index: 1;
...
{{--                        <a href="#schd" class="primary-btn d-inline-flex align-items-center"><span class="mr-10">Schedule</span><span class="lnr lnr-arrow-down"></span></a>--}}
    ...
    <section style="background-color: white">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <h2 style="text-align: center;">Glimpses of iUnderstand</h2>
                <p style="text-align: justify;padding:0% 3%">With workshops being held in more than 50 colleges throughout the country, iUnderstand is Techfest’s step towards making a financially independent and literate India. </p>
            </div>

            <div class="col-md-12" style="padding: 40px">
                <div class="row">
                    <div class="col-md-3">
                        <img src="/2019/initiatives/financial_literacy/IMG1.jpg" alt="" style="width: 100%;padding: 4% 0%">
                    </div>
                    <div class="col-md-3">
                        <img src="/2019/initiatives/financial_literacy/IMG2.jpeg" alt="" style="width: 100%;padding: 4% 0%">
                    </div>
                    <div class="col-md-3">
                        <img src="/2019/initiatives/financial_literacy/IMG3.jpg" alt="" style="width: 100%;padding: 4% 0%">
                    </div>
                    <div class="col-md-3">
                        <img src="/2019/initiatives/financial_literacy/IMG4.jpeg" alt="" style="width: 100%;padding: 4% 0%">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
{{--                        <h2>Structure and Schedule</h2>--}}
{{--                        <p>The examination portal will open on different days for different regions as mentioned below. Students will submit their proposed solution after they have gone through a series of MCQ questions.--}}
{{--                        </p>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                    <h4 style="color: white;text-align: center;">SUBMISSIONS</h4>--}}
    ...
    <section id="cnt" class="footer-widget-area">
        <div class="container">
            <div class="row" style="margin-top: 10px;">
                <div class="col-md-3 "data-aos="fade-right" data-aos="fade-down-left">
                    <div class="single-widget">
                        <div class="desc">
                            <div class="logo">
                                <a href="https://techfest.org/"><img src="/2019/tf_date.png" alt="" style="height: 50px;"></a>
                            </div>
                            <br>
                        </div>
                    </div>
                        ...
                        <div class="desc">
                            ...
                            <div class="row gg">
                                <div class="col-sm-6" style=" color: white;font-size: 19px;text-align: center;">
                                    <b>Prateek Mohanani </b><br>+91 7045409458<br>
                                    <a href="mailto:prateek@techfest.org" style="text-decoration: none;">
                                        <p style="text-align: center;font-size: 19px ; margin-top: 14px;">prateek@techfest.org</p>
                                    </a>
                                </div>
                                <div class="col-sm-6" style="font-size: 19px;text-align: center;">
                                    <b>Adamya Gupta </b><br>+91 9833958399<br>
                                    <a href="mailto:adamya@techfest.org" style="text-decoration: none;">
                                        <p style="text-align: center;font-size: 19px ; margin-top: 14px;">adamya@techfest.org</p>
                                    </a>
                                </div>
                                <div class="col-sm-12">
