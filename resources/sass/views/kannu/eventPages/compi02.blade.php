...
<!--           <p style="font-size:25px;color:lightslategray;">
			...
			<p>
				Every big projects we see today, definitely has some out of the box ideas forming its foundation. Buildings are getting built everyday, and the Cranes that play vital role in its construction is is need of newer designs and structure with the developing world. 
			</p>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="https://techfest.org/CraneOMania" target="_blank">
      ...
      <div class="col-sm-4">
        <img src="img/2018/spon1.png" style="width: 160px;margin-left: 90px;">
      </div>
			</p>
 -->
...
<div id="myNav06" class="overlayTwo">
  <div class="overlayTwo-content" style="font-size: 2vh;color:white;">
	<a href="http://techfest.org/Bajajhackathon" style="color:white;">Bajaj Electricals Hackathon</a>
    <a href="http://techfest.org/CraneOMania" style="color:white;">Crane-o-Mania</a>
  </div>
</div>
...
<div id="myNav07" class="overlayTwo">
  <div class="overlayTwo-content" style="font-size: 2vh;color:white;">
    ...
    <a href="http://techfest.org/rollcage" style="color:white;">Roll Cage</a>
    
    <a href="http://techfest.org/overwatch" style="color:white;">Overwatch</a>
