...
@section('centerOne')
    ...
    letter-spacing: 3px;color: #fefefe" id="abhinav">TECHNOHOLIX</h4>
...
">
    ...
    ">
            <div id="kaushik00">
                ...
                With the fall of dusk, the crowded theater reverberates with the roar of the audience as their heartbeats synchronize with the breathtaking performances by the artists from all around the world.
            ...
            <div id="kaushik01">
                ...
                As the day nears its close, the streets that were otherwise to witness some of the fiercest rivalries from geeks around the nation suddenly fill with an aura of excitement over the promise of world class entertainment. Technoholix acts as the perfect opportunity for an audience of 15,000 to rejuvenate by bringing forth a perfect blend of science, technology and entertainment. It has hosted pyrotechnics, laser shows, tron dance, magic, UV light shows, acrobatics and even virtual 3D holographic displays. Justifying its name, Technoholix promises to fill the veins of the audience with adrenaline and leave a look of awe on the faces of thousands.
            </div>


            <div id="kaushik02" style="text-align: left;">
                <p>
                    Direct entry will be given to students with IITB identity card or valid accommodation identity during festival.
                </p>
                <p>
                    For outsiders, passes will be distributed at
                </p>
                <div style="padding-left:2em;">
                    <p>- &nbsp; &nbsp;Day Cafeteria in front of Hostel 10</p>
                    <p>- &nbsp; &nbsp;Hospitality Room near Hostel 1</p>
                    <p>*No entry will be given without a hardcopy of the pass</p>
                    <p>*Passes will be distributed on all three days</p>
                    Entry starts from 6 PM and the show will end by 10 PM.
                </div>
            </div>
            ...
            <div id="kaushik03">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/05JvHiHYC_s?rel=0&amp;showinfo=0" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>

                <div class="row">
                    <p style="font-family: 'pirulen';font-size: 2rem;text-align: center;">Headlining</p>
                    <div class="col-sm-3"></div>
                    <div class="col-sm-4">
                        <img src="img/2018/techX04.png" style="width: 160%;">
                    </div>
                ...
                <div class="row">
                    <!-- <p style="font-family: 'pirulen';font-size: 2rem;text-align: center;">Headlining</p> -->
                    <div class="col-sm-4">
                        <p style="font-family: 'pirulen';font-size: 1.4rem;text-align: center;">Supporting</p>
                        <img src="img/2018/techX02.png" style="width: 100%;">
                    </div>
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4">
                        <p style="font-family: 'pirulen';font-size: 1.4rem;text-align: center;">Presenting</p>
                        <img src="img/2018/techX03.png" style="width: 100%;">
                    </div>
                </div>
            ...
            <div id="kaushik05" style="display:none;">
                ...
                <p style="text-align: center;">
                    <a href="https://www.facebook.com/shubh.agy" style="text-decoration: none;color: white;">Shubham Goyal</a><br>
                    <a href="mailto:shubham@techfest.org" style="text-decoration: none;color: #fefefe"> shubham@techfest.org</a>
                    <a href="" style="text-decoration: none;color: #fefefe"> +91 800 347 3030 </a>
                </p>
            </div>
        </div>
    ...
    <div class="mobileCenter">
        ...
        <h4 id="heading" class="heading">TECHNOHOLIX</h4>
        ...
        <div class="parent" style="font-family: 'Play';">
            ...
            <div class="child">
                ...
                <div style="padding-left:2em;" class="contentMobile">
                    <p>- &nbsp; &nbsp;Day Cafeteria in front of Hostel 10</p>
                    <p>- &nbsp; &nbsp;Hospitality Room near Hostel 1</p>
                    <p>*No entry will be given without a hardcopy of the pass</p>
                    <p>*Passes will be distributed on all three days</p>
            ...
            <div class="child" style="color: white;font-family: 'pirulen';">

                <div class="row">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/05JvHiHYC_s?rel=0&amp;showinfo=0" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
                    <p style="font-size: 4rem;text-align: center;margin-top: 20px;margin-bottom: 0;">Headlining</p><hr>
                    <div class="col-sm-3"></div>
                    <div class="col-sm-4">
                        <img src="img/2018/techX04.png" style="width: 160%;">
                    </div>
                ...
                <div class="row">
                    <!-- <p style="font-family: 'pirulen';font-size: 2rem;text-align: center;">Headlining</p> -->
                    <div class="col-sm-4">
                        <p style="font-size: 2rem;text-align: center;margin-bottom: 0;">Supporting</p><hr>
                        <img src="img/2018/techX02.png" style="width: 100%;">
                    </div>
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4">
                        <p style="font-size: 2rem;text-align: center;margin-bottom: 0;">Presenting</p><hr>
                        <img src="img/2018/techX03.png" style="width: 100%;">
                    </div>
                </div>
            ...
            <div class="child">
                ...
                <p class="contentMobile">
                    <a href="https://www.facebook.com/divyanshu.prasad.79" style="text-decoration: none;color: #fefefe">Shubham Goyal</a><br>
                    <a href="mailto:divyanshu@techfest.org" style="text-decoration: none;color: #fefefe"> shubham@techfest.org</a>
                    <a href="" style="text-decoration: none;color: #fefefe">+91 800 347 3030</a>
                </p>
                </p>
    ...
    left: 59%;" class="circleLapi">
            <img src="img/2018/techx.png" style="position: absolute;
    width: 65%;top:-4%;" >
        </div>
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            <a href="#" onclick="closeNav(1)">Introduction</a>
            <a href="#" onclick="closeNav(2)">Entry</a>
            <a href="#" onclick="closeNav(3)">31st December</a>
            <a href="#" onclick="closeNav(4)">Register</a>
