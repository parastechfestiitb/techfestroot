...
<head>
    ...
    <!-- JS -->
    <script src="js/summit_js/webfont.js" type="text/javascript" async=""></script>
...
<body id="page-top" data-spy="scroll" style="overflow-x: hidden;width: 100vw;" >
        ...
        <div class="navbar-header">
            ...
            <div id="myNav" class="overlay">
                ...
                <div class="overlay-content">
                    ...
                    <a href="https://techfest.org/hospitality" onclick="closeNav()">Accomodation</a>
        ...
        <div id="navbar" class="navbar-collapse collapse" style="max-height: 560px;">
            <ul class="nav navbar-nav" style="display: block;float: right;position: fixed;top: 0;right: 0;">
                ...
                <li class="dropdown mega-fw">
                    <a href="#home" class="dropdown-toggle hvr-glow"  >Home</a>
                </li><!-- / Home -->
                <li class="dropdown mega-fw">
                ...
                <!--   <li class="dropdown mega-fw">
                   <a href="" class="dropdown-toggle hvr-glow"  >Accomodation</a>
                 </li -->>
                <li class="dropdown mega-fw">
        ...
        <div id="large-header" class="large-header" style="height: 570px;">
            ...
            <div class="hero-content-wrapper">
                <div class="hero-content">
                    ...
                    <h3 class="h-alt hero-secondary" style="font-weight: bold;">29<sup>th</sup> - 31<sup>st</sup> December 2017, IIT BOMBAY</h3>
            ...
            <div class="col-lg-6 col-md-6 mb-sm-50" >
                <div class="ft-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="animation-duration: 1s; animation-delay: 0.3s; visibility: visible;height: 400px;">
                    ...
                    <p><ul style="text-align: justify;"><li>Explore the business opportunities and challenges presented by Artificial Intelligence (AI)
                        ...
                        <li>Participants will get Techfest, IIT Bombay Certificates after completion of the summit.
                        </li></ul></p>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mb-sm-50" style="height: 400px;">
                <div class="ft-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s" style="animation-duration: 1s; animation-delay: 0.6s; visibility: visible;height: 400px;">
                    ...
                    <ul><li>Speakers will introduce AI, an area which has gained significant attention from researchers and entrepreneurs around the world.
                        ...
                        </li><li>Participants will get Techfest, IIT Bombay Certificates after completion of the summit.
                        </li></ul>
                    </p>
                </div>
            </div>
...
<section class="container-fluid portfolio-layout portfolio-columns-fw" id="speaker" style="margin-top: 40px !important;margin-bottom: 90px !important;">
    ...
    <div class="row">
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Mr. Rafiq Somani</h2>
                <p class="para">Country Manager - South Asia Pacific & Middle East, ANSYS</p>
                <div class="cta-container transition"><a class="cta">Mr. Rafiq Somani</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/rafiq.JPG') no-repeat center;    background-size: 60%;    margin-top: -0px;	"></div>
            </div>
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak"> Dr. (CDR.) Arnab Das</h2>
                <p class="para">Director Maritime Research Centre -AI Group</p>
                <div class="cta-container transition"><a class="cta">Dr. (CDR.) Arnab Das</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/arnab.JPG') no-repeat center bottom;background-size: 43%;"></div>
            </div>
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Sree Hari Nagaralu</h2>
                <p class="para">Principal Group Manager, AI & R Division, Microsoft</p>
                <div class="cta-container transition"><a class="cta">Sree Hari Nagaralu</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/sri .jpg') no-repeat center;    background-size: 60%;       background-position: 80% 139px;"></div>
            </div>
        ...
        {{--<p class="para">Country Manager - South Asia Pacific & Middle East, ANSYS</p>--}}
        {{--<div class="cta-container transition"><a class="cta">Mr. Rafiq Somani</a></div>--}}
        {{--<div class="card_circle transition" style="background: url('img/summit_img/speakers/sri .jpg') no-repeat center;    background-size: 60%;    margin-top: -0px;	"></div>--}}
        {{--</div>0--}}
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Arjun Satya</h2>
                <p class="para"> Lead Architect, Colombia, Times Internet </p>
                <div class="cta-container transition"><a class="cta">Arjun Satya</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/Arjun.jpg') no-repeat center;background-size: 50%; "></div>
            </div>
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Utpal Chakraborty</h2>
                <p class="para">Lead Architect, Artificial Intelligence &amp; Cognitive, L&amp;T Infotech</p>
                <div class="cta-container transition"><a class="cta">Utpal Chakraborty</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/utpal.JPG') no-repeat center;background-size: 44%;margin-top: -52px;	"></div>
            </div>

        </div>
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Akanksha Balani</h2>
                <p class="para">Country Lead- Developer Products Division|India & ANZ</p>
                <div class="cta-container transition"><a class="cta">Akanksha Balani</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/akanshaIntel.png') no-repeat center;background-size: 44%;margin-top: -52px;	"></div>
            </div>
        ...
        <div class="col-sm-3" style="padding: 20px;">
            <div class="card transition">
                <h2 class="transition ak">Ankur Dinesh Garg</h2>
                <p class="para">CEO of Hotify</p>
                <div class="cta-container transition"><a class="cta">Ankur Dinesh Garg</a></div>
                <div class="card_circle transition" style="background: url('img/summit_img/speakers/ankurdg.png') no-repeat center;background-size: 54%;margin-top: -52px;margin-left: -55px!important;	"></div>
            </div>
    ...
    <div class="row">
        ...
        <!--  <div class="col-sm-3" style="padding: 20px;">
             <div class="card transition">
               ...
               <p class="para">CEO of WNS Global Services,</p>
               <div class="cta-container transition"><a class="cta">Keshav R. Murugesh</a></div>
               <div class="card_circle transition" style="background: url('img/summit_img/speakers/rafiq .jpg') no-repeat center bottom;"></div>
             </div>
...
<div class="gray-bg">
                ...
                <div class="blog-post wow fadeIn" data-wow-duration="2s" style=" animation-duration: 2s; animation-name: none;">
                    ...
                    <div class="bp-content">
                        ...
                        <ul style="list-style-type:none;padding:0px; text-align: center;">
                            ...
                            <li style="textAlign:center;padding-top:5px;">LUNCH ON THREE DAYS </li>
                        </ul>
                        ...
                        <div class="text-center">
                            <p style="margin: auto;display: block;margin-top: 40px;"> <a href="" class="btn btn-small hvr-push" data-toggle="modal"  style="text-align: center;background:#2da2c8;">Registrations Closed</a></p>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-sm-50">
                <div class="blog-post wow fadeIn" data-wow-duration="2s" data-wow-delay=".3s" style=" animation-duration: 2s; animation-delay: 0.3s; animation-name: none;">
                    ...
                    <div class="bp-content">
                        ...
                        <!-- Link -->
                        <div class="text-center">
                            <p style="margin: auto;display: block;margin-top: 40px;"> <a href="" class="btn btn-small hvr-push"  style="text-align: center;background:#2da2c8;">Registrations Closed</a></p>
                        </div></div><!-- / .bp-content -->
    ...
    display: block;width: 50% !important;margin-left: auto;">
        ...
        <p style="textAlign:left;font-weight: bold;">**Refund deadline is 1st November 2017.</p>
        <p style="text-align:center;font-weight: bold;font-size: 20px;">For Accomodation <a href="https://techfest.org/hospitality">CLICK HERE</a></p>
</div>
<script type="text/javascript">
...
<section id="schedule">
    ...
    <div class="container">
        ...
        <div class="row">
                        ...
                        <div class="timeline-box mrg25A">
                            <div class="tl-row">
                                <div class="tl-item">
                                    ...
                                    <div class="tl-panel">7:00 - 8:30 AM</div>
                            ...
                            <div class="tl-row">
                                <div class="tl-item">
                                    ...
                                    <div class="popover left" >
                                        ...
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-success">Day 1</div>
                                            <p class="tl-content"><b>Microsoft Workshop </b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Day 3 -->
            <div class="col-md-4 active-sched" id="sched3" style="margin-top: 1%;">
                <div class="content-box mrg25T mrg25B">
                    <p style="text-align: center;font-size: 150%;padding-top: 10px;"><b style="border:2px solid #9cd159;padding: 5px;padding-left: 15px;padding-right: 15px;">Day Three</b></p>
                    <div class="content-box-wrapper">
                        <div class="timeline-box mrg25A">
                            <div class="tl-row">
                                <div class="tl-item">
                                    <div class="tl-icon bg-green"><i class="glyph-icon icon-cog "></i></div>
                                    <div class="tl-panel">8:30 - 9:00 AM</div>
                                    <div class="popover left" >
                                        <div class="arrow"></div>
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-success" style="margin-bottom: 0px">Day 3</div>
                                            <p class="tl-content" style="margin-bottom: 0px"><b>Entries Start</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tl-row">
                                <div class="tl-item float-right">
                                    <div class="tl-icon bg-black"><i class="glyph-icon icon-cog"></i></div>
                                    <div class="tl-panel">9:00 - 12:00 PM</div>
                                    <div class="popover right">
                                        <div class="arrow"></div>
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-info">Day 3</div>
                                            <p class="tl-content" style="margin-bottom: 0px"><b>Intel Workshop Phase1</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tl-row demo-margin">
                                <div class="tl-item">
                                    ...
                                    <div class="popover left">
                                        <div class="arrow"></div>
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-success">Day 3</div>
                                            <p class="tl-content" style="margin-bottom: 0px"><b>Lunch and Networking</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tl-row">
                                <div class="tl-item float-right">
                                    ...
                                    <div class="popover right" >
                                        ...
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-info ">Day 3</div>
                                            <p class="tl-content" style="margin-bottom: 0px"><b>Intel Workshop Phase2</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tl-row demo-margin">
                                <div class="tl-item">
                                    <div class="tl-icon bg-green"><i class="glyph-icon icon-cog"></i></div>
                                    <div class="tl-panel">5:00 PM</div>
                                    <div class="popover left">
                                        <div class="arrow"></div>
                                        <div class="popover-content">
                                            <div class="tl-label bs-label label-success">Day 3</div>
                                            <p class="tl-content" style="margin-bottom: 0px"><b>Summit Closing</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="dark-bg" style="background-color: white;margin-top: 30px;margin-bottom: 50px;font-size: 35px;">
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-sm-6">
                    <div style="">
                        <h3 style="color: black;text-align: center;">Workshop By<br> Intel</h3>
                        <p class="abhelo" style="color: #777;font-family: "Open Sans","Helvetica Neue",Helvetica,sans-serif;  ">The workshop will be on Artificial Intelligence. Workshop will be organised by Intel.
                        </p>
                        <p style="margin: auto;display: block;margin-top: 40px;text-align: center;"> <a href="/resource/INTEL.pdf" class=" btn-small hvr-push" style="text-align: center;background:#2da2c8;color: black;font-weight: bold;">Details</a></p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div style="">
                ...
                <p style="color: black;font-size: 12px;font-weight: bold;margin-top: 10px;text-align: center;">**Participants will get Techfest IIT Bombay Certificate after completion of Summit</p>
            </div>
...
<section class="hackathon" style="background-color: #black;">
    <div class="dark-bg" style="background-color: white;margin-top: 30px;margin-bottom: 50px;font-size: 35px;">
        <div class="container">


            <div class="row" style="padding-top: 20px;">
                <h3 style="color: black;text-align: center;">News Article Recommender</h3>
                <div class="col-sm-6">
                    <img src="img/summit_img/hackathon.jpg" style="width: 80%;border-radius: 5%;margin-left: 10%;margin-top:50px;">
                    <p style="width: 80%;border-radius: 5%;margin-left: 10%;margin-top: 21px;font-size: 20px;"> <b>**This Competition is not compulsory</b></p>
                    <p style="margin: auto;display: block;margin-top: 40px;text-align: center;"> <a href="/times" class=" btn-small hvr-push" style="text-align: center;background:#2da2c8;color: black;font-weight: bold;">Details</a></p>
                </div>
                <div class="col-sm-6">
                    <div style="">

                        <h6 style="color: black;margin-bottom: 15px;">About</h6>
                        <p class="abhelo" style="color: #777;font-family: "Open Sans","Helvetica Neue",Helvetica,sans-serif;  ">Have you ever thought, why the stuff that interests you the most is always on the top of your web feed. Here is where the intelligence of computer comes into picture. The internet stores data of each and every step you do and reacts accordingly.
                        ...
                        <h6 style="color: black;margin-bottom: 15px;">Task</h6>
                        <p class="abhelo" style="color: #777;font-family: "Open Sans","Helvetica Neue",Helvetica,sans-serif;  "><p class="abhelo" style="color: #777;font-family: "Open Sans","Helvetica Neue",Helvetica,sans-serif;  ">The objective of this challenge is to develop a model to predict click
...
<section id="sponsor">
    <div class="dark-bg" style="background-color: white;margin-top: 30px;margin-bottom: 50px;font-size: 35px;">
        <div >
            ...
            <hr class="hrab" style="
    margin: auto;margin-bottom: 20px;text-align: center;">

            <div class="row mobile" style="padding-top: 20px;">
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Brought to you by</p>
                    <img src="img/summit_img/spo/main.jpg" style="width: 60%;display: block;margin: auto;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Hands-on Partner</p>
                    <img src="img/summit_img/spo/Intel.png" style="width: 60%;margin-top: 40px;display: block;margin: auto;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Workshop Partner</p>
                    <img src="img/summit_img/spo/microsoft.png" style="width: 60%;display: block;margin: auto;margin-top: 20px;">
                </div>
                <div class="col-sm-2">
                    <img src="img/summit_img/spo/wns.png" style=" margin-top: 6%;width: 50%;margin-top: 60px;display: block;margin: auto;padding-top: 40px;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Ecosystem partner</p>
                    <img src="img/summit_img/spo/sine.jpg" style="width: 60%;margin-top: 30px;display: block;margin: auto;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Summit Kit Partners</p>
                    <img src="img/summit_img/spo/sponso.png" style="width: 60%;margin-top: 30px;display: block;margin: auto;">
                </div>
            </div>
            ...
            <div class="row lapi" style="padding-top: 20px;">
                ...
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Brought to you By</p>
                    <img src="img/summit_img/spo/main.jpg" style="width: 80%; margin-left: 30%;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Hands-on Partner</p>
                    <img src="img/summit_img/spo/Intel.png" style="width: 65%; margin-left: 30%;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Workshop Partner</p>
                    <img src="img/summit_img/spo/microsoft.png" style="width: 80%;margin-left: 25%;margin-top: 20px;">
                </div>
                <div class="col-sm-2">
                    <img src="img/summit_img/spo/wns.png" style=" margin-top: 6%;width: 80%;margin-left: 20%;margin-top: 75px;">
                </div>
                <div class="col-sm-2">
                    <p style="font-size: 20px;text-align: center;margin-top: 10px;">Ecosystem partner</p>
                    <img src="img/summit_img/spo/sine.jpg" style="width: 80%; margin-left: 30%;">
                </div>
                <div class="col-sm-2">
                    <img src="img/summit_img/spo/sponso.png" style="width: 60%;margin-top:6%; margin-right: 30%;">
                </div>
                ...
                <address class="contact-info-wrapper">
                    <ul>
                        <li class="contact-group">
                            ...
                            <span class="adr-info">LH101 Lecture Hall Complex, IIT Bombay</span>
                        </li>
                        <li class="contact-group">
                            <span class="adr-heading">Date</span>
                            <span class="adr-info">29<sup>th</sup> - 31<sup>st</sup> December 2017</span>
                        </li>
                    </ul>
