...
@section('title','Rollcage | Competitions ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Rollcage</h4>
...
<!-- first extend  -->
	...
	<div id="kaushik0" class="kaushik" style="display: block;">
		...
		<p>
			In an era with ever increasing importance to automation Techfest invites you to go hardcore mechanical. RollCage is a competition with a vision to innovate in automation of Needle roller and cage assemblies.
	...
	<div id="kaushik1" class="kaushik">
		...
		<p>
Participants are invited to innovate and design a similar machine as of Needle roller and cage assembly to facilitate automation.
	...
	<div id="kaushik2" class="kaushik">
		...
		So that we can review your abstract and know about the genuinity of you project.<br><br>
<b>Where do I have to send the abstract?</b><br> Mail it to: rollcage@techfest.org
<br><br>
...
<br><br>
<b>How to register ?</b><br> Please follow this process:- www.techfest.org -> Competitions -> Contrivance -> Rollcage -> Register 
<br><br></p>
<!--
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/rollcage.pdf" target="_blank">
				...
				<div class="grid">
					<a id="compi02" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a id="compi02" href="/register/rollcage">
							<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
								<line class="top" x1="0" y1="0" x2="200" y2="0"/>
								<line class="left" x1="0" y1="0" x2="0" y2="50"/>
								<line class="bottom" x1="0" y1="50" x2="200" y2="50"/>
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading">Rollcage</h4>
		...
		<div class="child">
			...
			<p>
				<ul class="contentMobile" style="list-style-type: none;"> 
					...
					<li>
						 How to register ?<br>
						<p>Please follow this process:- www.techfest.org -> Competitions -> Contrivance -> Rollcage -> Register </p>
				    </li>
<!--
				    <li>
		...
		<div class="child">
			...
			<p>
				<ul class="contentMobile"> 
					...
					<p>So that we can review your abstract and know about the genuinity of you project. </p>
					<li>
						 Where do I have to send the abstract? 
				    </li>
				    <p>Mail it to: rollcage@techfest.org</p>
		...
		<div class="child">
			<div class="contentMobile">
				<div class="row" style="margin: 5vh;text-align: center;">
					<!--<a href="https://www.facebook.com/abhinav.kaushik.568" target="_blank" style="text-decoration: none;color: white;"-->Prithviraj Gawande<br>
Events Mananger <br>
