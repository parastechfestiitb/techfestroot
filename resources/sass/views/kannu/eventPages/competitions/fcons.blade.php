...
@section('title','Crane-o-Mania | Competitions')
...
<div style="" class="contentLaptop">
	...
	<img src="https://techfest.org/img/sponsors/18/afcons.png" style="position: fixed;top: 25vh;right: 29vw;width: 200px;">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Crane-o-Mania</h4>
...
<!-- first extend  -->
	...
	<div id="kaushik0" class="kaushik" style="display: block;">
		...
		<p>Every big projects we see today, definitely has some out of the box ideas forming its foundation. Cranes play a vital role in challenging projects and are in need of newer designs and structure with the developing world. 
			 
			 Techfest, in association with AFCONS, brings forth Crane-o-Mania, where young minds are provided a platform to flow their ideas for making a change in this sector. If you are a young structural design enthusiast, this is competition, you should participate in.</p>
	</div>
	<div id="kaushik1" class="kaushik">
		<p class="content-sub-heading" style="font-size:25px;">TASK</p>
		<p>
		Design a Tower Crane using popsicle sticks cotton strings and Fevicol as adhesive (without using any strengthening coating) that can sustain the maximum possible load with optimum radius and self-weight, satisfying all the understated constraints. </p>
	</div>	
...
Please follow this process:- www.techfest.org -> Competitions -> Crane-o-Mania -> Register
<br><br>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/Crane-o-Mania.pdf" target="_blank">
				...
				<div class="grid">
					<a id="compi02" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a id="compi02" href="/register/CraneoMania">
							<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
								<line class="top" x1="0" y1="0" x2="200" y2="0"/>
								<line class="left" x1="0" y1="0" x2="0" y2="50"/>
								<line class="bottom" x1="0" y1="50" x2="200" y2="50"/>
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading">Crane-o-Mania</h4>
...
Every big projects we see today, definitely has some out of the box ideas forming its foundation. Cranes play a vital role in challenging projects and are in need of newer designs and structure with the developing world. 
			 
			 Techfest, in association with AFCONS, brings forth Crane-o-Mania, where young minds are provided a platform to flow their ideas for making a change in this sector. If you are a young structural design enthusiast, this is competition, you should participate in.		</div>
		...
		<div class="child">
			...
			<p>
				<ul class="contentMobile" style="text-align: left;"> 
				    ...
				    <p>Please follow this process:- www.techfest.org -> Competitions -> Crane-o-Mania -> 
				    Register</p>
				    <li>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="resource/Crane-o-Mania.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
