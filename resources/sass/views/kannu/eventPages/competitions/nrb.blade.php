...
@section('title','NRB App | Competitions ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">NRB App</h4>
...
<br><br>
<b>How to register ?</b><br> Please follow this process:- www.techfest.org -> Competitions -> Contrivance -> NRB App -> Register 
<br><br>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/NRBApp.pdf" target="_blank">
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading">NRB App</h4>
...
<div class="parent" style="font-family: 'Play';">
		...
		<div class="child">
			...
			<p class="contentMobile">
				Ever wanted to feel the power of the driving force of F1 cars and Monster Trucks? Does your adrenaline level rush up after hearing the voice of an IC engine? Come and build your own beast machine at NRB App. Techfest 2017-18 gives you an opportunity to build your own IC car and prove your mettle against other racers on the track at NRB App.
			</p>
		</div>
		...
		<div class="child">
			...
			<p>
				<ul class="contentMobile" style="list-style-type: none;"> 
					...
					<li>
						 How to register ?<br>
						<p>Please follow this process:- www.techfest.org -> Competitions -> Contrivance -> NRB App -> Register </p>
				    </li>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="resource/NRBApp.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
