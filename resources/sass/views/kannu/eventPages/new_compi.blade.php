...
<div style="left:4.3vw;z-index:-1;" class="contentLaptop">
...
<div class="circleLapi">
	...
	<svg id="arc0" height="100%" width="100%" style="position: absolute;
		...
		<!-- 	<text x="80%" y="15.2620519696%" id="oneLL" class="nav-tab" fill="#fefefe"  text-anchor="end" style="filter: url(#blurFilter4);">
		    ...
		    <text x="93%" y="8.5386704767%" id="sixL" class="nav-tab" text-anchor="end" onclick="compibtn(30)" onmouseover="compibtn(30.1)">
				Spectacle
			</text>
		...
		<!-- <circle  cx="97.2%" cy="91.7%" r="4" stroke="white" fill="white"/>
		<circle id="cc07" cx="97.2%" cy="91.7%" r="12" stroke="white" stroke-width="1" fill="transparent"/>
		<circle id="c07" cx="97.2%" cy="91.7%" r="14" stroke="white" stroke-width="1" fill="transparent" style="stroke: none; fill: rgba(0,131,177,0.77); filter: url(#blurFilter4);"/>
