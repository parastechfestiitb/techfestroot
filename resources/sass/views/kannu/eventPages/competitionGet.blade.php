...
<div style="left:4.3vw;z-index:0;" class="contentLaptop">
...
">
	...
	">
		...
		<div class="descriptions" id="kaushik7" style="display:none;position:absolute;">
			<p>
				This competition is launched with the vision to ignite ideas and foster innovations to reform and transfigure the present scenario in India. Techfest summons all tinkerers to bring in their ideas and act to change the life of millions
			</p>
			<p style="color: #f9c111;">
				1. Bajaj Electricals Hackathon<br>
				2. Crane-o-Mania
			</p>
		</div>

		<div class="descriptions" id="kaushik8" style="display:none;position:absolute;">
			<p style="font-size:25px;color:lightslategray;">
				Automating NRB
			</p>
			<p>
				This is the time to bring all the theoretical knowledge to practical implementations for automation of Industries, time to use robots in place to do all the manual works that consumes manpower
	...
	<div class="row" style="position: relative;bottom: 15vh;left: 7vw;font-size: 18px;z-index:2;">
		<div class="col-sm-3">
	...
	<div class="row" style="position: relative;bottom: 2vh;">
		...
		<div class="col-sm-6">
			<a href="https://www.mouser.in/?utm_source=techfest&utm_medium=display&utm_campaign=mouser-in&utm_content=image" ><img src="/img/sponsors/mouse.png" style="width: 135px;"></a>
		</div>
	</div>
...
<div class="mobileCenter" style="opacity:1;filter:blur(0px);transition:all 0.3s linear;overflow-x;hidden;z-index:-1;">
	...
	<div class="row" style="position: relative;bottom: -8vh;">

		<div class="col-sm-8">
			<p style="color: white;font-size: 2.5rem">Electronics Component Sponsor</p>
		</div>
		<div class="col-sm-4">
			<a href="https://www.mouser.in/?utm_source=techfest&utm_medium=display&utm_campaign=mouser-in&utm_content=image" ><img src="/img/sponsors/mouse.png" style="width: 240px;"></a>
		</div>
	</div>
...
<div id="myNav" class="overlay">
	...
	<div class="overlay-content" style="font-size: 2vh;">
		...
		<a href="#" onclick="closeNav(1)">TECHNORION</a>
		<a href="#" onclick="closeNav(2)">INTERNATIONAL</a>
		<a href="#" onclick="closeNav(3)">CONTRIVANCE</a>
		<a href="#" onclick="closeNav(4)">Aerostrike</a>
		<a href="#" onclick="closeNav(5)">TATA Pioneer's MAKERTHON</a>
		<a href="#" onclick="closeNav(6)">Spectacle</a>
		<a href="#" onclick="closeNav(7)">Automating NRB</a>
...
<div id="myNav03" class="overlayTwo" >
	...
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/fullthrottle" style="color:white;">FULL THROTTLE</a>
		<a href="/codethegame" style="color:white;">Code The Game</a>
		<a href="/hilti" style="color:white;">Hilti Cadathon</a>
...
<div id="myNav01" class="overlayTwo">
	<!-- <a href="javascript:void(0)" class="closebtn" onclick="closeNavTwo(0)">&times;</a> -->
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/enigma" style="color:white;">ENIGMA</a>
		<a href="/meshmerize" style="color:white;">MESHMERIZE</a>
		<a href="/clutch" style="color:white;">VISE CLUTCH</a>
...
<div id="myNav02" class="overlayTwo">
	<!-- <a href="javascript:void(0)" class="closebtn" onclick="closeNavTwo(0)">&times;</a> -->
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/irc" style="color:white;">IRC</a>
		<a href="/robowars" style="color:white;">ROBOWARS</a>
...
<div id="myNav05" class="overlayTwo">
	<!-- <a href="javascript:void(0)" class="closebtn" onclick="closeNavTwo(0)">&times;</a> -->
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/automation" style="color:white;">AUTOMATION CHALLENGE</a>
		<a href="/uav" style="color:white;">UAV CHALLENGE</a>
	</div>
</div>
...
<div id="myNav04" class="overlayTwo">
	<!-- <a href="javascript:void(0)" class="closebtn" onclick="closeNavTwo(0)">&times;</a> -->
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/boeing" style="color:white;">Boeing National Aeromodelling Competition</a>
		<a href="/oprahat" style="color:white;">Op. Rahat</a>
	</div>
</div>

<div id="myNav06" class="overlayTwo">
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">
		<a href="/Bajajhackathon" style="color:white;">Bajaj Electricals Hackathon</a>
		<a href="/CraneOMania" style="color:white;">Crane-o-Mania</a>
	</div>
</div>

<div id="myNav07" class="overlayTwo">
	<div class="overlayTwo-content" style="font-size: 2vh;color:white;">

		<a href="/rollcage" style="color:white;">Roll Cage</a>

		<a href="/overwatch" style="color:white;">Overwatch</a>
...
<div id="myCompiNav" class="overlayTwo">
  ...
  overflow: scroll;">
		<!-- <a href="/uav" style="color:white;">Full Throttle</a> -->
		<a href="/Bajajhackathon" style="color:white;">Bajaj Electricals Hackathon</a>
		<a href="/rollcage" style="color:white;">Roll Cage</a>
		...
		<a href="/clutch" style="color:white;">VICE CLUTCH</a>
		<a href="/enigma" style="color:white;">ENIGMA</a>
		<a href="/meshmerize" style="color:white;">MESHMERIZE</a>
		...
		<a href="/boeing" style="color:white;">Boeing</a>
		<a href="/oprahat" style="color:white;">OP. RAHAT</a>
...
<script>
    ...
    function closeNav(argument) {
        ...
        var myNav06 = document.getElementById("myNav06");
        var myNav07 = document.getElementById("myNav07");
        ...
        if (argument== 0 ) {
            ...
            myNav06.style.width = "0%";
            myNav07.style.width = "0%";
...
<div class="circleLapi">
	<div style="position: relative;
		...
		width: 77%;top:8%;opacity:0;" >
		<img class="ring" id="compitab" src="img/2018/enigma.png" style="position: absolute;
		width: 77%;top:8%;opacity:0;" >
	...
	<svg id="arc0" height="100%" width="100%" style="position: absolute;
		...
		<text x="93%" y="8.5386704767%" id="sixL" class="nav-tab" text-anchor="end" onclick="compibtn(100)" onmouseover="compibtn(30.1)">
			Spectacle
		</text>
		<text x="80%" y="18.2620519696%" id="oneL" class="nav-tab" fill="#ffffff"  text-anchor="end" onmouseover="compibtn(1.1)" onclick="compibtn(1)">
			CONTRIVANCE
		</text>
		...
		<text x="80%" y="84.7379480304%" id="fiveL" class="nav-tab" text-anchor="end" onclick="compibtn(5)" onmouseover="compibtn(5.1)">
			TATA PIONEER'S MAKERTHON
		</text>

		<text x="93%" y="93.5386704767%" id="sevenL" class="nav-tab" text-anchor="end" onclick="compibtn(31)" onmouseover="compibtn(31.1)">
			Automating NRB
		</text> -->
		...
		<circle  cx="84.9871204473%" cy="17%" r="4" stroke="white" fill="white"/>
		<circle id="cc01"  cx="84.9871204473%" cy="17%" r="12" stroke="white" stroke-width="1" fill="transparent"/>

		<circle id="c01"  cx="84.9871204473%" cy="17%" r="14" stroke="white" stroke-width="1" fill="transparent" style="stroke: none; fill: rgba(0,131,177,0.77); filter: url(#blurFilter4);"/>
		...
		<circle  cx="84.4%" cy="82.7379480304%" r="4" stroke="white" fill="white"/>
		<circle id="cc05" cx="84.4%" cy="82.7379480304%" r="12" stroke="white" stroke-width="1" fill="transparent"/>
		<circle id="c05" cx="84.4%" cy="82.7379480304%" r="14" stroke="white" stroke-width="1" fill="transparent" style="stroke: none; fill: rgba(0,131,177,0.77); filter: url(#blurFilter4);"/>

		<circle  cx="97.2%" cy="8.5%" r="4" stroke="white" fill="white"/>
		<circle id="cc06" cx="97.2%" cy="8.5%" r="12" stroke="white" stroke-width="1" fill="transparent"/>
		<circle id="c06" cx="97.2%" cy="8.5%" r="14" stroke="white" stroke-width="1" fill="transparent" style="stroke: none; fill: rgba(0,131,177,0.77); filter: url(#blurFilter4);"/>


		<circle  cx="97.8%" cy="91.7%" r="4" stroke="white" fill="white"/>
		<circle id="cc07" cx="97.8%" cy="91.7%" r="12" stroke="white" stroke-width="1" fill="transparent"/>
		<circle id="c07" cx="97.8%" cy="91.7%" r="14" stroke="white" stroke-width="1" fill="transparent" style="stroke: none; fill: rgba(0,131,177,0.77); filter: url(#blurFilter4);"/>
	...
	<svg id="arc7" height="100%" width="100%" style="position: absolute;
		left: 50%;opacity: 0;z-index: -1;bottom: 1%;" stroke="white"  stroke-width="1.5">
		...
		<text x="70%" y="30.5386704767%" id="twoL" class="nav-tab" text-anchor="end" onclick="compibtn(51)" style="font-size: 12px">
			Roll Cage
		</text>
		<text x="70%" y="71.5386704767%" id="fourL" class="nav-tab" text-anchor="end" onclick="compibtn(52)" style="font-size: 12px">
			Overwatch
		</text>
		<text x="80%" y="87.7379480304%" id="fiveL" class="nav-tab" text-anchor="end" onclick="">
	...
	<svg id="arc8" height="100%" width="100%" style="position: absolute;
		left: 50%;opacity: 0;z-index: -1;bottom: 1%;" stroke="white"  stroke-width="1.5">
		...
		<text x="70%" y="30.5386704767%" id="twoL" class="nav-tab" text-anchor="end" onclick="compibtn(61)" style="font-size: 12px">
			Bajajhackathon
		</text>
		<text x="70%" y="71.5386704767%" id="fourL" class="nav-tab" text-anchor="end" onclick="compibtn(62)" style="font-size: 12px">
			CraneOMania
		</text>
		<text x="80%" y="87.7379480304%" id="fiveL" class="nav-tab" text-anchor="end" onclick="">
...
<script type="text/javascript">
    ...
    function compibtn(argument) {
        ...
        if (argument==0) {
            ...
            $("#arc7").animate({left: '50%', opacity: '0',filter:blur(5),scale:0.5,zIndex:-1}, "slow");
            $("#arc8").animate({left: '50%', opacity: '0',filter:blur(5),scale:0.5,zIndex:-1}, "slow");
            ...
            document.getElementById("kaushik8").style.display="none";
            document.getElementById("international").style.opacity="0";
            document.getElementById("compitab").style.opacity="0";
        ...
        if (argument==100) {
            divone.innerHTML = 'Spectacle';
            back.style.display="inline";
            $("#arc0").animate({left: '-17%',zIndex:-1, opacity: '0',filter:blur(5)}, "slow");
            $("#arc8").animate({left: '-17%',zIndex:1, opacity: '1',filter:blur(5)}, "slow");
            document.getElementById("kaushik0").style.display="none";
            document.getElementById("kaushik1").style.display="none";
            document.getElementById("kaushik2").style.display="none";
            document.getElementById("kaushik3").style.display="none";
        ...
        if (argument==31) {
            $('#abhinav').css('font-size', '2rem');
            divone.innerHTML = 'Automating  NRB';
            // divone.innerHTML = 'INTERNATIONAL';
            back.style.display="inline";
            $("#arc0").animate({left: '-17%',zIndex:-1, opacity: '0',filter:blur(5)}, "slow");
            $("#arc7").animate({left: '-17%',zIndex:1, opacity: '1',filter:blur(5)}, "slow");
            document.getElementById("kaushik0").style.display="none";
            document.getElementById("kaushik1").style.display="none";
            document.getElementById("kaushik2").style.display="none";
            document.getElementById("kaushik3").style.display="none";
            ...
            document.getElementById("kaushik6").style.display="none";
            document.getElementById("kaushik7").style.display="none";
            document.getElementById("kaushik8").style.display="block";
            document.getElementById("international").style.opacity="0";
            document.getElementById("compitab").style.opacity="0";
            document.getElementById("meshmerize").style.opacity="0";
            document.getElementById("enigma").style.opacity="0";
        ...
        if (argument==30) {
            // window.location.href='/CraneOMania';
        }

        if (argument==51) {
            window.location.href='/rollcage';
        }
        if (argument==52) {
        ...
        if (argument==61) {
            window.location.href='/Bajajhackathon';
        }
        if (argument==62) {
            window.location.href='/CraneOMania';
        }
