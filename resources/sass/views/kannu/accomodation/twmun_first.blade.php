...
<form id="form-work" class="" name="form-work" method="POST" action="/twmun/success" >
...
<div class="form-group">
<div class="col-md-6">
<input name="room_type" class="form-control" value="Treebo" type="hidden" required >
</div>
</div>
...
<div class="form-group">
<div class="col-md-6">
<label class="control-label" for="room">Accommodation for</label>
<select class="form-control" id="" name="days" required>
<option value="">Select</option>
...
<p style="color: white"><b>**Available dates for accommodation are 28,29,30,31st of December</b></p>
