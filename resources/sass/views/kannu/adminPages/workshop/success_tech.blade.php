    ...
    <body>
        <div class="container">
            <div class="content">
                ...
                <p style="font-size: 40%;">Your NYE ID : {{$event_id_mail}}</p>
                <p style="font-size: 30%;">You will recieve a confirmation mail on your registered Email ID :<b> {{$email}} </b></p>
                    </div>
                <a href="{{$payment_link}}">
                <button class="btn">Technoholix</button>
                </a>
