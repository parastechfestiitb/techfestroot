...
<link rel="stylesheet" type="text/css" href="css/eventmobileT.css">

<link rel="stylesheet" type="text/css" href="css/eventmobileTT.css">
...
.mobiList{display: block;text-decoration: none;}
 #ab023{margin-bottom: 2vh;}
.mobiList a{color: #89eeff;}
.mobilList a:active {
    color: white;
...
<map name="image-map">
    <area target="" alt="" title="" href="/" coords="365,1,365,200,681,200,684,0" shape="poly">
</map>
...
<div id="somedialog" class="dialog dialog--close">
                    ...
                    <div class="dialog__content">
                        ...
                        <div class="dialog-inner" style="border-radius: 6%;">
                            ...
                            <h2 style="color: black"><strong>Cyclothon | Pedal for Better Heart</strong></h2>
                            <h2 style="color: black"><a href="//events/cyclothon" target="_blank">Register Yourself</a></h2>
...
">
<?php echo '<p style="color:white;letter-spacing:2px;text-align:center;" class="blink">Techfest Official Aftermovie:- <a href="https://www.youtube.com/watch?v=2z3CEBv8PLI" target="_blank">WATCH HERE</a></p>'
 ?>
  ...
  <!-- <li style="margin-right: 0.6%;"><a href="/">HOME</a></li> -->
...
">
 ...
 ?>
  ...
  <li style="margin-right: 0.6%;"><a href="/mun" id="twmu">TWMUN</a></li>
...
<div style="width: 90%;
    ...
    text-align: center;
    height: 70%;
    position: fixed;font-family: 'pirulen';
    top: 15%;">
...
<div id="foot3" class="hidden-sm hidden-xs">
        <a style="margin-top:0.6%; padding-top: 0vh;padding-bottom: 0vh" class="link link--kukuri" href="/about" data-letters="ABOUT"  id="abou">ABOUT</a>
...
<div class="foot5">
<a href="https://www.facebook.com/iitbombaytechfest/" style="display: inline;" target="_blank">
...
<!-- mobile navigation bar ends herer -->


</div>

 <!-- this last div is for overalll layer  -->
