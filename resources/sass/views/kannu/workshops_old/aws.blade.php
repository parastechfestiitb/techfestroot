...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">All​ ​in​ ​Cloud:​ ​A​ ​Cloud​ ​Partner​ ​Perspective WORKSHOP</h4>
...
<!-- first extend  -->
	...
	<div id="kaushik0" class="kaushik" style="display: block;">
		...
		<p>
		Workshop on learning Amazon Wedserver and cloud deployments.
		</p>
	</div>
	...
	<div id="kaushik2" class="kaushik">
		...
		<p>
			<b>9.00 am to 9.45 am :</b> Deep Learning Demystified and Applied Deep Learning (lecture)<br>
			<b>10 am to 12.00 am:</b> Image Classification with DIGITS (lab)<br>
			...
			<b>12:00pm </b>     Lunch<br>

			<b>1:00pm </b>       Object Detection with DIGITS (LAB)<br>
			...
			<b>3:00 pm</b>       Break<br>

			<b>3:15 pm </b>      Neural Network Deployment with DIGITS and TensorRT (lab)<br>
			...
			<b>5:15 pm</b> Closing Comments &amp; Questions<br>
...
<div class="row comeon" style="position:relative; left:10vh;">
	...
	<div class="col-sm-4">
		<div class="col-sm-12 prize">
			<p class="prizes">Cost<br>INR 1,500/ Per Person-</p>
		</div>
	</div>
	<div class="col-sm-4">
        <section class="demo-3" class="lapitopi">   
...
<div class="parent" style="font-family: 'Play';">
		...
		<div class="child">
			...
			<div class="psMobi">
			<!-- <hr style="width:93%">	 		 -->
			<a href="#" style="color:white;"><b>COST INR 1,500/ Per Person</b></a>
			</div>
