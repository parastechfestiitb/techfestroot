...
@section('title','Virtual Reality | Workshops ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Virtual Reality </h4>
...
<!-- first extend  -->
    ...
    Time: 9am-5pm</p>
		<p>
	Get hands-on experience of VR content creation and to enable yourself to create, discover & consume VR experience
		</p>
	</div>
	<div id="kaushik1" class="kaushik">
		...
		<br><b>Cost of Workshop:</b>₹ 1,400/- per team<br>
...
<br><b>**If the Workshop gets cancelled, all the participants will be given full refund, irrespective of the Deadline.</b><br>
	...
	<div id="kaushik2" class="kaushik">
		...
		<p>
					 ...
					 <b> Day 1:</b><br><br>
               - Introduction to VR.<br>
               - Types of VR.<br>
               - Devices used in VR<br>
               - Application of VR <br>
               - Why VR is future?<br>
               - Introduction to PPTVR.in<br>
               - Walk-through with PPTVR.IN .<br>
               -Text Feature in PPTVR.IN<br>
               - Add multimedia in PPTVR.IN.<br>
               - Add Grid and Carousal in PPTVR.IN.<br>
               - Add pdf documents <br>
               - Add Nevigation Menu and 3D menu.<br>
               - How to create website in PPTVR.IN in minutes.<br><br> 

      <b>Day 2:</b><br><br>
               - How to host website.<br>
               - Hand on experience of creating VR projects. <br><br>

				<br>For detailed course content, kindly <a href="/resource/workshop/vr.pdf">Click here</a>.
	...
	<div id="kaushik3" class="kaushik">
		...
		<p>
            ...
            <br><b>Team specifications  :</b>	
     		<br>Participants will have to register in a team with maximum of one member in it. <br>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="/resource/workshop/vr.pdf" target="_blank">
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading"> Virtual Reality </h4>
    ...
    Time: 9am-5pm</p>
		...
		<div class="child">
			...
			<p class="contentMobile">
				...
				<br>Team can consist of maximum 1 members <br>
			<br><b>Refund Deadline:</b> 1st November 2017, No Refunds will be entertained after the Deadline.<br>
		        <br><b>**Limited number of seats</b><br>
<br><b>**If the Workshop gets cancelled, all the participants will be given full refund, irrespective of the Deadline.</b><br>
			</p>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="/resource/workshop/vr.pdf";
	}
