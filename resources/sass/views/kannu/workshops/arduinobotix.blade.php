...
@section('title','ArduinoBotix| Workshops ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">ArduinoBotix WORKSHOP</h4>
...
<!-- first extend  -->
    ...
    Time: 9am-5pm</p>
		<p>
		Arduino is an open-source electronics prototyping platform (Embedded System) based on flexible, easy-to-use hardware and software.
		</p>
	</div>
	<div id="kaushik1" class="kaushik">
		...
		<br><b>Cost of Workshop:</b>₹ 5,000/- per team<br>
        <br><b>No. of Team Members: </b>4 <br>
...
<b><li>Introduction to Robotics & Open Source Platform</b></li><ul>
<li>Applications and Future Scope</li></ul>
<br>
<b><li>Micro – Controllers and its features</b></li><ul>
<li>Overview of Opensource Hardware.</li>
<li>Microcontroller Architecture.</li>
<li>Atmega in Arduino</li>
<li>Arduino Board Layout and Arduino Platform</li></ul>
<br>
<b><li>Software Tools</b></li><ul>
<li>Software Installation</li>
<li>Getting Started with Arduino IDE</li>
<li>How to use the IDE and connect your Board to the Laptop.</li>
<li>Write your sample programs.</li></ul>
<br>
<b><li>Interfacing of I/O Devices</b></li><ul>
<li>Interfacing a LED</li>
<li>Interfacing a Motor</li>
<li>Interfacing Analog and Digital Sensors</li></ul>
<br>
<b><li>Other Topics</b></li><ul>
<li>ADC</li>
<li>Timers and Interrupts</li></ul>
<br>
<b><li>Hands-On Sessions</b></li><ul>
<li>LED Patterns</li>
<li>Line Following Robot</li>
<li>Obstacle Avoider Robot</li>
<li>Edge Avoider Bot</li>
<li>Wall Following Robot</li></ul>
<br>
<br>For more detail Content <a href="/resource/workshop/ArduinoBotix.pdf">Click Here</a>
	...
	<div id="kaushik4" class="kaushik">
		...
		<div class="col-sm-12">
			<p>Mrityunjay Kumar<br>
				mrityunjay@techfest.org<br>
				+91 8879137304<br></p>
		</div>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/workshop/ArduinoBotix.pdf" target="_blank"> 
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading">ArduinoBotix</h4>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="resource/workshop/ArduinoBotix.pdf";              // ===================================================
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
