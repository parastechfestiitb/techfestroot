...
@section('title','Gesture Robotics | Workshops ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Gesture Robotics </h4>
...
<!-- first extend  -->
    ...
    Time: 9am-5pm</p>
		Gesture Robotics is a new approach of human interface with robots. It is based on the implementation of acceleration sensor on robotics, graphics and embedded application development.
		</p>
	</div>
	...
	<div id="kaushik2" class="kaushik">
		...
		<p>
			...
			<br><br>
				...
				Gesture Controlled Robotics – Basics and why is it different?
				<ul>
				<li>What is already in place?</li>
				<li>Types of Robot Sensors</li>
				<li>Application of Gesture Controlled robotics</li>
				<li>What can you do in the future ?</li>
				</ul><br>
				...
				Microcontrollers
				<ul>
				<li>uC and its Architecture</li>
				<li>I/O Functions</li>
				<li>Programming a uC</li>
				</ul><br>
				Actuators

				<ul>
				<li>Motor Control</li>
				<li>Different Types of Actuators</li>
				<li>H- Bridge Concept</li>
				</ul><br>
				Fabrication of a the kit provided

				<ul>
				<li>Assembling the kit</li>
				<li>Understanding the Kit and the Functions</li>
				<li>Software Installation</li>
				<li>Writing Codes</li>
				</ul><br>

			<br>For detailed course content, kindly <a href="/resource/workshop/Gesture.pdf">Click here</a>.
	...
	<div id="kaushik4" class="kaushik">
		...
		<div class="col-sm-12">
			<p>Divyanshu Prasad<br>
				divyanshu@techfest.org<br>
				+91 8569917969<br></p>
		</div>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/workshop/Gesture.pdf" target="_blank">
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading"> Gesture Robotics </h4>
...
<div class="parent" style="font-family: 'Play';">
		...
		<div class="child">
			...
			<p class="contentMobile">
				ACCELERO-BOTIX is a new approach of human interface with robots. It is based on the implementation of acceleration sensor on robotics, graphics and embedded application development.
			</p>
		</div>
		...
		<div class="child">
			...
			<p>
				<ul class="contentMobile" style="list-style-type: none;"> 
					<b>Topics to be covered</b>
<ul>
<li>Introduction to Robotics and Combination of Robotics with Gesture Robotics</li>
...
<br>
Amazing it is , now use Gesture Robotics  to control a power point presentation by using your hands, no Mouse or Keyboard is required.
...
<li>Go for Competition.</li>
		...
		<div style="padding-top:0.5vh;" >
				...
				<section class="demo-3" id="mobi01">
					...
					<a id="compi02" href="/AcceleroBotix">
										<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
											<line class="top" x1="0" y1="0" x2="200" y2="0"/>
											<line class="left" x1="0" y1="0" x2="0" y2="50"/>
											<line class="bottom" x1="0" y1="50" x2="200" y2="50"/>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="/resource/workshop/Gesture.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
