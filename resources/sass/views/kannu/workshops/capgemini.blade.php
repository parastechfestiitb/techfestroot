...
@section('title','Capgemini\'s Learn Book | Workshops')
@section('styling')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Capgemini's Learn Book </h4>
...
<!-- first extend  -->
    ...
    Time: 9am-5pm</p>
		<p>
  <b>Digital customer experience and Business Intelligence</b><br><br>

	Come ideate and co-create with Capgemini an education platform which simplifies knowledge sharing within the student community. We are naming it the “Learn Book”, but will pick your minds for fresh ideas. The platform that we intend to co-create is democratic in every sense of the word, i.e. by the students, for the students and of the students. The use though is not limited to the students only, it can be used by any group of individuals, who are working towards a unified target. Target can be educational, or a complex project delivery, learn book will offer a unique and a broad platform for all the knowledge needs.
		</p>
	</div>
	<div id="kaushik1" class="kaushik">
		...
		<br><b>Cost of Workshop:</b><br>₹ 1,400/- per team<br>


		<br>Team can consist of maximum 1 member <br>
		<br><b>Refund Deadline:</b> 30th November 2017, No Refunds will be entertained after the Deadline.<br>
...
<br><b>**If the Workshop gets cancelled, all the participants will be given full refund, irrespective of the Deadline.</b><br>
	...
	<div id="kaushik2" class="kaushik">
		...
		<p>
			...
			<b>The key features that we envisage for the Learn Book platform are:</b><br><br>
·       Competency building model with available public contents and mash up against a syllabus<br>
·       Enable assisted education from master level candidates<br>
·       Content approved by teaching faculties<br>
·       Enable 3rd party certifications or internal certifications against the modules<br>
·       Sharing notes against the modules<br>
·       Ask a doubt<br>
·       Plan the learning – use analytics to figure out the complexity, duration & plan<br>
·       Topic based content extraction<br>
·       Create a frontend (Desktop/Mobile)<br><br>
				<br>For detailed course content, kindly <a href="/resource/workshop/capgemini.pdf">Click here</a>.
	...
	<div id="kaushik3" class="kaushik">
		...
		<p>
			...
			<br>Entrepreneurial mind-set along with one laptop and a dongle/Jio with them.<br>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="/resource/workshop/capgemini.pdf" target="_blank">
					...
					<a id="compi02" href="#">
						<div class="box" style="margin-left: 0rem;">
							<p class="btnText" style="color:#dafdff" id="compiName02">
								<a href="/workshop/capgemini" id="compiName02" style="color:#dafdff">CLOSED !</a>
							</p>
							<a id="compi02" href="#">
							<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
								<line class="top" x1="0" y1="0" x2="200" y2="0"/>
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading">Capgemini's Learn Book </h4>
...
·       Create a frontend (Desktop/Mobile)<br><br>
		...
		<div class="child">
			...
			<div class="psMobi">
			<!-- <hr style="width:93%">	 		 -->
			<a href="#" style="color:white;"><b>Date: 30th December 2017 </b></a>
			</div>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="/resource/workshop/capgemini.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
