...
<!-- first extend  -->
    ...
    <p style="color: yellow">Date: 28th December 2017<br>
      Venue: LA 101<br>
    ...
    <br><b>Duration:</b>  1 Day (8 Hour Workshop) <br>
...
<br><b>**If the Workshop gets cancelled, all the participants will be given full refund, irrespective of the Deadline.</b><br>
    ...
    <p>
      ...
      <b>5:30 pm</b> End<br>
      <br>For more detail Content <a href="/resource/workshop/DeepLearning.pdf">Click Here</a>
...
<div class="row comeon" style="position:relative; left:10vh;">
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="resource/workshop/DeepLearning.pdf" target="_blank"> 
	...
	<div class="col-sm-4">
		<div class="col-sm-12 prize">
			<p class="prizes">Date : <br>28th December 2017</p></p>
		</div>
	</div>
	<div class="col-sm-4">
        <section class="demo-3" class="lapitopi">   
