...
@section('title','Internet of Things | Workshops ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Internet of Things </h4>
...
<!-- first extend  -->
    ...
    Time: 9am-5pm</p>
		<p>
	This workshop offers a neat introduction on the “Internet of Things” and is based on the advanced development tools from Texas Instruments. The Tiva-C LaunchPad and the CC3100 BoosterPack offer a complete wifi IOT solution while the integration of Energia with the IOT platform simplifies the IOT application development. 
		</p>
	</div>
...
Features<br>
<br>
11:15am- 1:00pm<br><br>

Energia Framework<br>
Overview of Energia<br>
Lab: Led, switch, UART, ADC, PWM Labs using Energia<br>
<br>
2:00pm- 3:30pm<br><br>

Internet of Things<br>
What is IOT?<br>
TCP/IP, internet terminologies<br>
CC3100 Booster-Pack overview<br>
<br>
3:45pm-5:00pm<br><br>

TCP Client Server Paradigm<br>
Lab: Client Server Communication.<br>
<br>
Day 2:<br><br>

9:30am-11:00am<br><br>

UDP Client Server Paradigm<br>
Lab: Client Server Communication.<br><br>

11:15am- 1:00pm<br><br>

Implementing the MQTT protocol.<br>
Lab: Transmitting short messages through Public network.<br>
<br>

2:00pm- 3:30pm<br><br>

Blynk Cloud Service<br>
Lab: controlling peripheral through android app.<br><br>

3:45pm-5:00pm<br><br>

FreeBoard Cloud Service<br>
Lab: SensorData Logging using public HTTP
<br>

				<br>For detailed course content, kindly <a href="/resource/workshop/IoT.pdf">Click here</a>.
	...
	<div id="kaushik3" class="kaushik">
		...
		<p>
			...
			<br>Each participant should bring one laptop with USB port connection. Teams should also bring Dongle/Jio along with them.<br>
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading"> Internet of Things </h4>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="/resource/workshop/IoT.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
