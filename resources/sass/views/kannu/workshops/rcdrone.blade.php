...
@section('title','Quadcopter:RC Drone Workshop | Workshops ')
...
<div style="" class="contentLaptop">
	...
	letter-spacing: 3px;color: #fefefe" id="abhinav">Quadcopter: RC Drone Workshop </h4>
...
<!-- first extend  -->
	...
	<div id="kaushik1" class="kaushik">
		...
		<br>Team can consist of maximum 5 members <br>
...
<br><b>**If the Workshop gets cancelled, all the participants will be given full refund, irrespective of the Deadline.</b><br>
	...
	<div id="kaushik2" class="kaushik">
		...
		<p>
					...
					<b>Session​ ​1:</b><ul>
					<li>Introduction to Flying Drones</li>
					<li>Discussion about Tri copter, Quadcopter, Hexa copter</li>
					<li>Working Principle of Quadcopter.</li>
					<li>Constituents required for Drones</li>
					<li>Flight control board</li>
					...
					<li>Introduction to kit contents</li></ul>


					<br><b>Session​ ​2:</b><ul>
					<li>Introduction to Arduino Microcontroller</li>
					<li>Installation of Arduino IDE</li>
					<li>Programming for Motor control</li>
					<li>Programming for Motor Speed Control</li>
					<li>Working of Motor driver with Microcontroller</li></ul>


					<br><b>Session​ ​3:</b><ul>
					<li>Constructional Concepts Quadcopter Frame.</li>
					<li>Assembly and Construction of quadcopter</li>
					<li>Connection consideration of various configurations</li>
					<li>Operation of Gyroscopes Micro Controller KK2.1.5</li></ul>


					<br><b>Session​ ​4:</b><ul>
					<li>Calibration of KK Flight control board</li>
					<li>Motor Testing with Remote</li>
					<li>Android App/ RF Remote Testing with Quadcopter</li>
					<li>Group wise Flying session</li></ul>



				<br>For detailed course content, kindly <a href="/resource/workshop/RCDrone.pdf">Click here</a>.
	...
	<div id="kaushik3" class="kaushik">
		...
		<p>
            ...
            <br><b>Team specifications  :</b>	
     		<br>Participants will have to register in a team with maximum of five members in it. <br>
				...
				<div class="grid">
					<a  id="compi01" href="#">
						<div class="box" style="margin-left: 0rem;">
							...
							<a href="/resource/workshop/RCDrone.pdf" target="_blank">
...
<div class="mobileCenter">
	...
	<h4 id="heading" class="heading"> Quadcopter: RC Drone Workshop </h4>
...
<div class="parent" style="font-family: 'Play';">
    ...
    Time: 9am-5pm</p>
		...
		<div class="child">
			...
			<p class="contentMobile">
				<br><b> Date:</b> 30th - 31st December<br>
...
function closeNav(argument) {
   ...
   con[0].style.display="none";
	...
	window.location.href="/resource/workshop/RCDrone.pdf";
    // document.getElementById("myNav").style.width = "0%";
    // con[0].style.display="none";
    // con[1].style.display="none";
    // con[2].style.display="none";
