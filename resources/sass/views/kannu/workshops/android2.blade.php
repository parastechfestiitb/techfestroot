...
<div class="col-sm-12 prize">
			<p class="" style="width: 100%;color: white;">Slot 1: 30th-31st December, Slot 2: 28th-29th December</p>
</div>
					...
					<a id="compi02" href="#">
						<div class="box" style="margin-left: 0rem;">
							<p class="btnText" style="color:#dafdff" id="compiName02">
								<a href="#" id="compiName02" style="color:#dafdff">Slot 1 (Closed) </a>
							</p>
							<a id="compi02" href="/android"><!-- ============================================== -->
							<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
								<line class="top" x1="0" y1="0" x2="200" y2="0"/>
								<line class="left" x1="0" y1="0" x2="0" y2="50"/>
								<line class="bottom" x1="0" y1="50" x2="200" y2="50"/>
        ...
        <section class="demo-3" class="lapitopi">   
				<div class="grid">
					<a id="compi02" href="#">
						<div class="box" style="margin-left: 0rem;">
							<p class="btnText" style="color:#dafdff" id="compiName02">
								<a href="#" id="compiName02" style="color:#dafdff">Close (Slot 2) </a>
							</p>
							<a id="compi02" href="/android"><!-- ======================================= -->
							<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
								<line class="top" x1="0" y1="0" x2="200" y2="0"/>
...
<br>For detailed course content, kindly <a href="/resource/workshop/android.pdf">Click here</a>.
		...
		<div class="child">
			...
			<div class="psMobi">
			<!-- <hr style="width:93%">	 		 -->
			<a href="#" style="color:white;"><b>Slot 1: 30-31st December (Closed)</b></a>
			<a href="#" style="color:white;"><b>Slot 2: 28-29th December (Open)</b></a>
			</div>
		...
		<div style="padding-top:0.5vh;" >
				...
				<section class="demo-3" id="mobi01">
					...
					<a id="compi02" href="/resource/workshop/android.pdf"><!-- ============================================== -->
										<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
											<line class="top" x1="0" y1="0" x2="200" y2="0"/>
											<line class="left" x1="0" y1="0" x2="0" y2="50"/>
											<line class="bottom" x1="0" y1="50" x2="200" y2="50"/>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="#" onclick="closeNav(6)">Register <i style="color: white">(For Date 30-31th Dec)<sup>Closed</sup></i></a>
