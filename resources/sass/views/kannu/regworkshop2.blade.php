                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <input name="email" required class="form-control" placeholder="Emiail ID" type="email">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="sel11" name="year" required>
                                <option value="">Select</option>
                                <option value="student">Student</option><option value="professor">Professor</option><option value="professional">Professional</option>
                            </select>
                        </div>
                    </div>
        ...
        <div id="wrapper" class="container" style="overflow: scroll;">
            <form id="form-work" class="" name="form-work" method="POST" action="/responseworkshop" >
                ...
                <fieldset>
                    ...
                    <label for="team_members" id="sub-sub" style="font-size: 20px;">Number of team members including the team leader:</label>
...
<script type="text/javascript">
    ...
    function new_email(n) {
        ...
        var email='<div class="form-group"><div class="col-md-6"><label class="control-label" for="team_id">Email</label><input name="email'+ n +'" required class="form-control" placeholder="Emiail ID" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" type="email"></div></div>';
