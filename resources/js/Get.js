...
const routes = [
    ...
    {path:'/lectures',component:require('./components/Lectures'),name:'Lectures', meta:{
        title: 'Techfest | Asia\'s Largest Science & Technology Festival',
        metaTags:[
            {
                name: 'description',
    ...
    {path:'/summit',component:require('./components/Summit'),name:'Summit', meta:{title:'Summit | Techfest 2018-19'}},
    ...
    {path:'/hospitality',component:require('./components/Hospitality'),name:'Hospitality', meta:{title:'Hospitality | Techfest 2018-19'},meta:{title:"Hospitality | Techfest 2018-19"}},
    ...
    {path:'/workshops',component:Event,name:'Workshop', meta:{title:'Workshops | Techfest 2018-19'}},
    ...
    {path:'/summit18',component: require('./components/Summit')},
