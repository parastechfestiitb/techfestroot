    ...
    <main>
        ...
        <div class="d-flex">
            <div class="left-container">
                <h1 class="title play-font">Exhibitions</h1>
                <div class="container-nav d-flex justify-content-between flex-nowrap">
                    ...
                    <div @click="changeContent('for-visitors')" class="for-visitors">For Visitors</div>
                    <div @click="changeContent('tech-connect')" class="tech-connect">Tech Connect</div>
                    <!--<div @click="changeContent('exhibitors')" class="exhibitors">Exhibitors</div>-->
                    <div @click="changeContent('contact')" class="contact">Contact</div>
                </div>
            ...
            <div class="right-container">
                ...
                <div class="previous-year-message text-warning">*Previous Exhibits*</div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        data: function(){
            return {
                content: {
                    'about':'<span class="quote">&ldquo;It’s not what you look at that matters, it’s what you see.<BR> See it to Believe it.&rdquo;</span><br><br> In its 22nd edition, Techfest is back and ready to amaze you, showcasing the technologies of the times of ancient civilizations to the modern out of the box innovations. Exhibitions at Techfest are one of those rare avenues where you can see and experience the grandness of what the world calls modern science and technology. It provides an amazing and unique experience. With exhibits of such quality to Techfest, IIT Bombay, Exhibitions provide you an ideal platform to explore technological advancement and update your tech know-how.\n',
                    'for-visitors':'There is no entry fee for Exhibitions at Techfest, everybody can attend it free of cost. \n They must, at all times carry a valid ID proof with them. Visitors below 14 years of age are advised to visit the Exhibitions in the early morning. Exhibitions will be at display from 9 A.M. to 3 P.M. on all 3 days of the Festival.\n',
                    ...
                    // 'exhibitors':'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam fugiat magnam, modi mollitia nam nobis obcaecati odio officiis reiciendis tempore! Accusantium commodi doloremque doloribus officiis rem repellat repellendus veniam veritatis!\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam fugiat magnam, modi mollitia nam nobis obcaecati odio officiis reiciendis tempore! Accusantium commodi doloremque doloribus officiis rem repellat repellendus veniam veritatis!\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam fugiat magnam, modi mollitia nam nobis obcaecati odio officiis reiciendis tempore! Accusantium commodi doloremque doloribus officiis rem repellat repellendus veniam veritatis!\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam fugiat magnam, modi mollitia nam nobis obcaecati odio officiis reiciendis tempore! Accusantium commodi doloremque doloribus officiis rem repellat repellendus veniam veritatis!\n',
