        ...
        <div class="payment-container  o-hidden-x" v-else>
            <div class="d-flex segments w-100">
                <div class="team-members">
                    ...
                    <div class="d-flex">
                        <input :autofocus="true" class="item border-top-0 border-left-0" type="text" placeholder="Enter Team Id" v-model="teamId">
...
<script>
    export default {
        ...
        methods: {
            ...
            getTeam: function () {
                axios.post('/api/get-team-details', {teamId: parseInt(this.teamId.split('-').pop().replace(/[^0-9]/g, ''), 10)})
                    .then(r => {
...
<style scoped>
    ...
    .slctd2{
        height: calc(100% - 11.7vw) !important;
    }
    .item{
