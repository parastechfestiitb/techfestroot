<template>
    <main v-if="element!==null" :style="{height:mainHeight+'px'}">
        ...
        <div class="left-container" :class="loginModal?'blur':''">
            <div class="back-button" @click="$root.routeChange('/compiadmin')">
                <i class="fas fa-chevron-left"></i>
            </div>
            <div class="short-description" v-html="element.description.short_description"></div>
            <div class="prize-money">Prize Money Worth INR {{numberWithCommas(element.amount)}}/-</div>
            ...
            <div class="fixed-section">
                <div class="relative ">
                    <div class="register-container" v-if="isSignedIn!==null">
                        ...
                        <div v-else-if="element.zonal===1" class="dropdown d-inline-block">
                            <button class="global-button register" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Register</button>

                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" @click="registerZonal('Bhopal')" href="#">Bhopal</a>
                                <a class="dropdown-item" @click="registerZonal('Jaipur')" href="#">Jaipur</a>
                                <a class="dropdown-item" @click="registerZonal('Mumbai')" href="#">Mumbai</a>
                                <a class="dropdown-item" @click="registerZonal('Kolkata')" href="#">Kolkata</a>
                                <a class="dropdown-item" @click="registerZonal('Balnglore')" href="#">Banglore</a>
                            </div>
                        </div>
                        <button v-else class="global-button register" @click="register">Register</button>
                        <button v-if="!isRegistered" @click="joinTeam">Join A Team</button>
            ...
            <div class="centered">
                <div class="modal-body">
                    <div class="instructions" v-if="isLeader===1"><span class="inst">Instruction</span>
                        <div class="message">Hi, you have been successfully registered for {{element.name}}, and you are the leader. If they have already registerd, enter their name and email below, or share the link with them to get them registered.</div>
                    ...
                    <div class="instructions" v-else><span class="inst">Instruction</span>
                        <div class="message">Hi, you have been successfully registered for {{element.name}}. You can ask your team leader to add more members.</div>
                        <div class="message">Your Team Id is : {{element.code}}-{{('000000'+team_id).slice(-6)}}</div>
                    </div>
                    ...
                    <div class="footer-add-member">
                        <button @click="addMember" v-if="element.participants - team.length > 0 && isLeader===1">+ Add Member</button>
        ...
        <div class="payment-modal d-flex justify-content-center" v-if="payementModal">
            <iframe src="https://www.thecollegefever.com/events/iframe/widget/techfest-2018-19-iit-bombay" frameborder="0" allowfullscreen width="320" height="510" overflow="hidden" seamless="seamless"></iframe>
        </div>
    </main>
</template>
