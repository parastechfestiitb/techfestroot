...
echo '$config["system.logging"]["error_level"] = "verbose";' >> reg_form/sites/default/settings.php
php ./reg_form/core/scripts/drupal install --no-interaction demo_umami > output
