...
class Random
{
    ...
    static function string($length)
    {
        ...
        // PHP isn't low level to be able to use those as sources and on a reg_form server there's not likely
        // going to be a ton of keyboard or mouse action. reg_form servers do have one thing that we can use
