                        ...
                        <div>
                            <div class="nk-carousel-3" data-size="1">
                                <div class="nk-carousel-inner nk-popup-gallery">
                                    <div>
                                        <div>
                                            <a href="http://techfest.org/gamersleague/images/csgo.jpg" class="nk-gallery-item" data-size="780x990">
                                                <img src="http://techfest.org/gamersleague/images/csgo.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <a href="http://techfest.org/gamersleague/images/csgo.jpg" class="nk-gallery-item" data-size="780x990" style="background:black">
                                                <img src="http://techfest.org/gamersleague/images/csgo.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
...
{{--                                                    <input type="text" id="team" class="form-control required text-warning" value="http://techfest.org/gamersleague/joincsgo/{{$csgo->id}}/{{md5($csgo->image.$key)}}" readonly>--}}
{{--                                                @endif--}}
...
{{--                                                                        <br>--}}
{{--                                                                        @if($csgo->leader!==$member->steamid)<span class="text-warning pointer" onclick="window.location.href='http://techfest.org/gamersleague/removecsgo/{{$member->steamid}}'">Remove</span>@endif--}}
{{--                                                                    </td>--}}
{{--                                                                @endforeach--}}
{{--                                                            </tr>--}}
{{--                                                        @else--}}
...
{{--                                                    </table>--}}
{{--                                                    @if($csgo->leader === $player->steamid)--}}
{{--                                                        <a class="float-right text-danger" href="http://techfest.org/gamersleague/removecsgo/{{$player->steamid}}">Delete Team</a>--}}
{{--                                                    @else--}}
{{--                                                        <a href="http://techfest.org/gamersleague/removecsgo/{{$player->steamid}}" class="float-right text-danger">Leave Team</a>--}}
{{--                                                    @endif--}}
{{--                                                </div>--}}
{{--                                                <div class="nk-gap"></div>--}}
{{--                                            </div>--}}
